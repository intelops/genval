...
// func ContainerHandeler(reqinput, output, inputpolicy, outputpolicy string) (string, error) {
// 	if reqinput == "" || output == "" || inputpolicy == "" || outputpolicy == "" {
// 		log.Errorf("Required arguments missing")
// 	}

// 	bc, err := exec.Command("genval", "--mode", "container", "--reqinput", reqinput, "output", output, "--inputputpolicy", inputpolicy, "--outputpolicy", outputpolicy).Output()
// 	if err != nil {
