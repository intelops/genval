...
#MultiplexInitParameters: {
	// A list of availability zones. You must specify exactly two.
	availabilityZones?: [...null | string] @go(AvailabilityZones,[]*string)

	// Multiplex settings. See Multiplex Settings for more details.
	multiplexSettings?: [...#MultiplexMultiplexSettingsInitParameters] @go(MultiplexSettings,[]MultiplexMultiplexSettingsInitParameters)
...
#MultiplexMultiplexSettingsInitParameters: {
...
#MultiplexSpec: {
	...
	// autoscaler.
	initProvider?: #MultiplexInitParameters @go(InitProvider)
}
