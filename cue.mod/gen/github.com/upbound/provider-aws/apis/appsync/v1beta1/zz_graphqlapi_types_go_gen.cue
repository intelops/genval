...
#AdditionalAuthenticationProviderInitParameters: {
	// Authentication type. Valid values: API_KEY, AWS_IAM, AMAZON_COGNITO_USER_POOLS, OPENID_CONNECT, AWS_LAMBDA
	authenticationType?: null | string @go(AuthenticationType,*string)

	// Nested argument containing Lambda authorizer configuration. Defined below.
	lambdaAuthorizerConfig?: [...#LambdaAuthorizerConfigInitParameters] @go(LambdaAuthorizerConfig,[]LambdaAuthorizerConfigInitParameters)

	// Nested argument containing OpenID Connect configuration. Defined below.
	openidConnectConfig?: [...#OpenIDConnectConfigInitParameters] @go(OpenIDConnectConfig,[]OpenIDConnectConfigInitParameters)

	// Amazon Cognito User Pool configuration. Defined below.
	userPoolConfig?: [...#UserPoolConfigInitParameters] @go(UserPoolConfig,[]UserPoolConfigInitParameters)
}
...
#GraphQLAPIInitParameters: {
	// One or more additional authentication providers for the GraphqlApi. Defined below.
	additionalAuthenticationProvider?: [...#AdditionalAuthenticationProviderInitParameters] @go(AdditionalAuthenticationProvider,[]AdditionalAuthenticationProviderInitParameters)

	// Authentication type. Valid values: API_KEY, AWS_IAM, AMAZON_COGNITO_USER_POOLS, OPENID_CONNECT, AWS_LAMBDA
	authenticationType?: null | string @go(AuthenticationType,*string)

	// Nested argument containing Lambda authorizer configuration. Defined below.
	lambdaAuthorizerConfig?: [...#GraphQLAPILambdaAuthorizerConfigInitParameters] @go(LambdaAuthorizerConfig,[]GraphQLAPILambdaAuthorizerConfigInitParameters)
	...
	// Nested argument containing OpenID Connect configuration. Defined below.
	openidConnectConfig?: [...#GraphQLAPIOpenIDConnectConfigInitParameters] @go(OpenIDConnectConfig,[]GraphQLAPIOpenIDConnectConfigInitParameters)
	...
	// Amazon Cognito User Pool configuration. Defined below.
	userPoolConfig?: [...#GraphQLAPIUserPoolConfigInitParameters] @go(UserPoolConfig,[]GraphQLAPIUserPoolConfigInitParameters)

	// Whether tracing with X-ray is enabled. Defaults to false.
	xrayEnabled?: null | bool @go(XrayEnabled,*bool)
}

#GraphQLAPILambdaAuthorizerConfigInitParameters: {
...
#GraphQLAPIOpenIDConnectConfigInitParameters: {
...
#LambdaAuthorizerConfigInitParameters: {
	// Number of seconds a response should be cached for. The default is 5 minutes (300 seconds). The Lambda function can override this by returning a ttlOverride key in its response. A value of 0 disables caching of responses. Minimum value of 0. Maximum value of 3600.
	authorizerResultTtlInSeconds?: null | float64 @go(AuthorizerResultTTLInSeconds,*float64)
...
#OpenIDConnectConfigInitParameters: {
	// Number of milliseconds a token is valid after being authenticated.
	authTtl?: null | float64 @go(AuthTTL,*float64)
...
#GraphQLAPISpec: {
	...
	// autoscaler.
	initProvider?: #GraphQLAPIInitParameters @go(InitProvider)
}
