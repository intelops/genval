...
#AccountRecoverySettingInitParameters: {
	// List of Account Recovery Options of the following structure:
	recoveryMechanism?: [...#RecoveryMechanismInitParameters] @go(RecoveryMechanism,[]RecoveryMechanismInitParameters)
}
...
#AdminCreateUserConfigInitParameters: {
	// Set to True if only the administrator is allowed to create user profiles. Set to False if users can sign themselves up via an app.
	allowAdminCreateUserOnly?: null | bool @go(AllowAdminCreateUserOnly,*bool)

	// Invite message template structure. Detailed below.
	inviteMessageTemplate?: [...#InviteMessageTemplateInitParameters] @go(InviteMessageTemplate,[]InviteMessageTemplateInitParameters)
}
...
#CustomEmailSenderInitParameters: {
...
#DeviceConfigurationInitParameters: {
...
#InviteMessageTemplateInitParameters: {
...
#LambdaConfigInitParameters: {
	...
	customEmailSender?: [...#CustomEmailSenderInitParameters] @go(CustomEmailSender,[]CustomEmailSenderInitParameters)

	// Custom Message AWS Lambda trigger.
	customMessage?: null | string @go(CustomMessage,*string)

	// A custom SMS sender AWS Lambda trigger. See custom_sms_sender Below.
	customSmsSender?: [...#CustomSMSSenderInitParameters] @go(CustomSMSSender,[]CustomSMSSenderInitParameters)
...
#NumberAttributeConstraintsInitParameters: {
...
#RecoveryMechanismInitParameters: {
...
#SMSConfigurationInitParameters: {
...
#SMSConfigurationParameters: {
	...
	// +kubebuilder:validation:Optional
	snsCallerArnRef?: null | v1.#Reference @go(SnsCallerArnRef,*v1.Reference)

	// Selector for a Role in iam to populate snsCallerArn.
	// +kubebuilder:validation:Optional
	snsCallerArnSelector?: null | v1.#Selector @go(SnsCallerArnSelector,*v1.Selector)
...
#SchemaInitParameters: {
	...
	numberAttributeConstraints?: [...#NumberAttributeConstraintsInitParameters] @go(NumberAttributeConstraints,[]NumberAttributeConstraintsInitParameters)

	// Whether a user pool attribute is required. If the attribute is required and the user does not provide a value, registration or sign-in will fail.
	required?: null | bool @go(Required,*bool)

	// Constraints for an attribute of the string type. Detailed below.
	stringAttributeConstraints?: [...#StringAttributeConstraintsInitParameters] @go(StringAttributeConstraints,[]StringAttributeConstraintsInitParameters)
}
...
#SoftwareTokenMfaConfigurationInitParameters: {
...
#UserAttributeUpdateSettingsInitParameters: {
...
#UserPoolInitParameters: {
	// Configuration block to define which verified available method a user can use to recover their forgotten password. Detailed below.
	accountRecoverySetting?: [...#AccountRecoverySettingInitParameters] @go(AccountRecoverySetting,[]AccountRecoverySettingInitParameters)

	// Configuration block for creating a new user profile. Detailed below.
	adminCreateUserConfig?: [...#AdminCreateUserConfigInitParameters] @go(AdminCreateUserConfig,[]AdminCreateUserConfigInitParameters)
	...
	deviceConfiguration?: [...#DeviceConfigurationInitParameters] @go(DeviceConfiguration,[]DeviceConfigurationInitParameters)

	// Configuration block for configuring email. Detailed below.
	emailConfiguration?: [...#EmailConfigurationInitParameters] @go(EmailConfiguration,[]EmailConfigurationInitParameters)
	...
	smsConfiguration?: [...#SMSConfigurationInitParameters] @go(SMSConfiguration,[]SMSConfigurationInitParameters)
	...
	softwareTokenMfaConfiguration?: [...#SoftwareTokenMfaConfigurationInitParameters] @go(SoftwareTokenMfaConfiguration,[]SoftwareTokenMfaConfigurationInitParameters)

	// Key-value map of resource tags.
	tags?: {[string]: null | string} @go(Tags,map[string]*string)

	// Configuration block for user attribute update settings. Detailed below.
	userAttributeUpdateSettings?: [...#UserAttributeUpdateSettingsInitParameters] @go(UserAttributeUpdateSettings,[]UserAttributeUpdateSettingsInitParameters)

	// Configuration block for user pool add-ons to enable user pool advanced security mode features. Detailed below.
	userPoolAddOns?: [...#UserPoolAddOnsInitParameters] @go(UserPoolAddOns,[]UserPoolAddOnsInitParameters)

	// Whether email addresses or phone numbers can be specified as usernames when a user signs up. Conflicts with alias_attributes.
	usernameAttributes?: [...null | string] @go(UsernameAttributes,[]*string)

	// Configuration block for username configuration. Detailed below.
	usernameConfiguration?: [...#UsernameConfigurationInitParameters] @go(UsernameConfiguration,[]UsernameConfigurationInitParameters)

	// Configuration block for verification message templates. Detailed below.
	verificationMessageTemplate?: [...#VerificationMessageTemplateInitParameters] @go(VerificationMessageTemplate,[]VerificationMessageTemplateInitParameters)
}
...
#UsernameConfigurationInitParameters: {
...
#VerificationMessageTemplateInitParameters: {
...
#UserPoolSpec: {
	...
	// autoscaler.
	initProvider?: #UserPoolInitParameters @go(InitProvider)
}
