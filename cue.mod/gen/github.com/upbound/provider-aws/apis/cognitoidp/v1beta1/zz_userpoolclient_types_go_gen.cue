...
#AnalyticsConfigurationInitParameters: {
...
#TokenValidityUnitsInitParameters: {
...
#UserPoolClientInitParameters: {
	...
	analyticsConfiguration?: [...#AnalyticsConfigurationInitParameters] @go(AnalyticsConfiguration,[]AnalyticsConfigurationInitParameters)
	...
	tokenValidityUnits?: [...#TokenValidityUnitsInitParameters] @go(TokenValidityUnits,[]TokenValidityUnitsInitParameters)
...
#UserPoolClientSpec: {
	...
	// autoscaler.
	initProvider?: #UserPoolClientInitParameters @go(InitProvider)
}
