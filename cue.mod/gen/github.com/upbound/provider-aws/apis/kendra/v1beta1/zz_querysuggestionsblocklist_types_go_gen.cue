...
#QuerySuggestionsBlockListInitParameters: {
	...
	sourceS3Path?: [...#SourceS3PathInitParameters] @go(SourceS3Path,[]SourceS3PathInitParameters)
...
#QuerySuggestionsBlockListSpec: {
	...
	// autoscaler.
	initProvider?: #QuerySuggestionsBlockListInitParameters @go(InitProvider)
}
