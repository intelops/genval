...
#AccessControlListConfigurationInitParameters: {
...
#BasicAuthenticationParameters: {
	...
	// +kubebuilder:validation:Optional
	credentialsRef?: null | v1.#Reference @go(CredentialsRef,*v1.Reference)

	// Selector for a Secret in secretsmanager to populate credentials.
	// +kubebuilder:validation:Optional
	credentialsSelector?: null | v1.#Selector @go(CredentialsSelector,*v1.Selector)
...
#ConditionInitParameters: {
	...
	conditionOnValue?: [...#ConditionOnValueInitParameters] @go(ConditionOnValue,[]ConditionOnValueInitParameters)
...
#ConditionOnValueInitParameters: {
...
#ConfigurationInitParameters: {
	...
	webCrawlerConfiguration?: [...#WebCrawlerConfigurationInitParameters] @go(WebCrawlerConfiguration,[]WebCrawlerConfigurationInitParameters)
}
...
#CustomDocumentEnrichmentConfigurationInitParameters: {
	...
	inlineConfigurations?: [...#InlineConfigurationsInitParameters] @go(InlineConfigurations,[]InlineConfigurationsInitParameters)
	...
	postExtractionHookConfiguration?: [...#PostExtractionHookConfigurationInitParameters] @go(PostExtractionHookConfiguration,[]PostExtractionHookConfigurationInitParameters)
	...
	preExtractionHookConfiguration?: [...#PreExtractionHookConfigurationInitParameters] @go(PreExtractionHookConfiguration,[]PreExtractionHookConfigurationInitParameters)
...
#DataSourceInitParameters: {
	...
	customDocumentEnrichmentConfiguration?: [...#CustomDocumentEnrichmentConfigurationInitParameters] @go(CustomDocumentEnrichmentConfiguration,[]CustomDocumentEnrichmentConfigurationInitParameters)
...
#InvocationConditionConditionOnValueInitParameters: {
	// A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, 2012-03-25T12:30:10+00:00.
	dateValue?: null | string @go(DateValue,*string)
...
#InvocationConditionInitParameters: {
	...
	// The value used by the operator. For example, you can specify the value 'financial' for strings in the _source_uri field that partially match or contain this value. See Document Attribute Value.
	conditionOnValue?: [...#InvocationConditionConditionOnValueInitParameters] @go(ConditionOnValue,[]InvocationConditionConditionOnValueInitParameters)
...
#PostExtractionHookConfigurationInitParameters: {
	...
	invocationCondition?: [...#InvocationConditionInitParameters] @go(InvocationCondition,[]InvocationConditionInitParameters)
...
#PreExtractionHookConfigurationInitParameters: {
	// A block that specifies the condition used for when a Lambda function should be invoked. For example, you can specify a condition that if there are empty date-time values, then Amazon Kendra should invoke a function that inserts the current date-time. See Document Attribute Condition.
	invocationCondition?: [...#PreExtractionHookConfigurationInvocationConditionInitParameters] @go(InvocationCondition,[]PreExtractionHookConfigurationInvocationConditionInitParameters)
...
#PreExtractionHookConfigurationInvocationConditionConditionOnValueInitParameters: {
	// A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, 2012-03-25T12:30:10+00:00.
	dateValue?: null | string @go(DateValue,*string)
...
#PreExtractionHookConfigurationInvocationConditionInitParameters: {
	// The identifier of the document attribute used for the condition. For example, _source_uri could be an identifier for the attribute or metadata field that contains source URIs associated with the documents. Amazon Kendra currently does not support _document_body as an attribute key used for the condition.
	conditionDocumentAttributeKey?: null | string @go(ConditionDocumentAttributeKey,*string)

	// The value used by the operator. For example, you can specify the value 'financial' for strings in the _source_uri field that partially match or contain this value. See Document Attribute Value.
	conditionOnValue?: [...#PreExtractionHookConfigurationInvocationConditionConditionOnValueInitParameters] @go(ConditionOnValue,[]PreExtractionHookConfigurationInvocationConditionConditionOnValueInitParameters)
...
#S3ConfigurationInitParameters: {
	...
	accessControlListConfiguration?: [...#AccessControlListConfigurationInitParameters] @go(AccessControlListConfiguration,[]AccessControlListConfigurationInitParameters)
	...
	documentsMetadataConfiguration?: [...#DocumentsMetadataConfigurationInitParameters] @go(DocumentsMetadataConfiguration,[]DocumentsMetadataConfigurationInitParameters)
...
#SeedURLConfigurationInitParameters: {
...
#SiteMapsConfigurationInitParameters: {
...
#TargetDocumentAttributeValueInitParameters: {
	// A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, 2012-03-25T12:30:10+00:00.
	dateValue?: null | string @go(DateValue,*string)
...
#TargetInitParameters: {
	...
	targetDocumentAttributeValue?: [...#TargetDocumentAttributeValueInitParameters] @go(TargetDocumentAttributeValue,[]TargetDocumentAttributeValueInitParameters)
...
#UrlsInitParameters: {
	...
	seedUrlConfiguration?: [...#SeedURLConfigurationInitParameters] @go(SeedURLConfiguration,[]SeedURLConfigurationInitParameters)
	...
	siteMapsConfiguration?: [...#SiteMapsConfigurationInitParameters] @go(SiteMapsConfiguration,[]SiteMapsConfigurationInitParameters)
}
...
#WebCrawlerConfigurationInitParameters: {
	...
	urls?: [...#UrlsInitParameters] @go(Urls,[]UrlsInitParameters)
}
