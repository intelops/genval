...
#InstanceInitParameters: {
	...
	blueGreenUpdate?: [...#BlueGreenUpdateInitParameters] @go(BlueGreenUpdate,[]BlueGreenUpdateInitParameters)
	...
	restoreToPointInTime?: [...#RestoreToPointInTimeInitParameters] @go(RestoreToPointInTime,[]RestoreToPointInTimeInitParameters)

	// Restore from a Percona Xtrabackup in S3.  See Importing Data into an Amazon RDS MySQL DB Instance
	s3Import?: [...#S3ImportInitParameters] @go(S3Import,[]S3ImportInitParameters)
...
#InstanceObservation: {
	...
	listenerEndpoint?: [...#ListenerEndpointObservation] @go(ListenerEndpoint,[]ListenerEndpointObservation)
	...
	masterUserSecret?: [...#MasterUserSecretObservation] @go(MasterUserSecret,[]MasterUserSecretObservation)
...
#InstanceParameters: {
	...
	// +kubebuilder:validation:Optional
	replicateSourceDbRef?: null | v1.#Reference @go(ReplicateSourceDBRef,*v1.Reference)

	// Selector for a Instance in rds to populate replicateSourceDb.
	// +kubebuilder:validation:Optional
	replicateSourceDbSelector?: null | v1.#Selector @go(ReplicateSourceDBSelector,*v1.Selector)
...
#ListenerEndpointInitParameters: {
}

#ListenerEndpointObservation: {
	// The hostname of the RDS instance. See also endpoint and port.
	address?: null | string @go(Address,*string)
...
#ListenerEndpointParameters: {
}

#MasterUserSecretInitParameters: {
}

#MasterUserSecretObservation: {
...
#MasterUserSecretParameters: {
}

#RestoreToPointInTimeInitParameters: {
