...
#ConnectionPoolConfigInitParameters: {
...
#ProxyDefaultTargetGroupInitParameters: {
	// The settings that determine the size and behavior of the connection pool for the target group.
	connectionPoolConfig?: [...#ConnectionPoolConfigInitParameters] @go(ConnectionPoolConfig,[]ConnectionPoolConfigInitParameters)
}
...
#ProxyDefaultTargetGroupSpec: {
	...
	// autoscaler.
	initProvider?: #ProxyDefaultTargetGroupInitParameters @go(InitProvider)
}
