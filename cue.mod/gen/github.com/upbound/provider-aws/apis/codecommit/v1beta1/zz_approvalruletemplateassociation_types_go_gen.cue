...
#ApprovalRuleTemplateAssociationInitParameters: {
}
...
#ApprovalRuleTemplateAssociationParameters: {
	...
	// +kubebuilder:validation:Optional
	approvalRuleTemplateNameRef?: null | v1.#Reference @go(ApprovalRuleTemplateNameRef,*v1.Reference)

	// Selector for a ApprovalRuleTemplate in codecommit to populate approvalRuleTemplateName.
	// +kubebuilder:validation:Optional
	approvalRuleTemplateNameSelector?: null | v1.#Selector @go(ApprovalRuleTemplateNameSelector,*v1.Selector)
...
#ApprovalRuleTemplateAssociationSpec: {
	...
	// autoscaler.
	initProvider?: #ApprovalRuleTemplateAssociationInitParameters @go(InitProvider)
}
