...
#UserInitParameters: {
	...
	identityInfo?: [...#IdentityInfoInitParameters] @go(IdentityInfo,[]IdentityInfoInitParameters)

	// The user name for the account. For instances not using SAML for identity management, the user name can include up to 20 characters. If you are using SAML for identity management, the user name can include up to 64 characters from [a-zA-Z0-9_-.\@]+.
	name?: null | string @go(Name,*string)

	// A block that contains information about the phone settings for the user. Documented below.
	phoneConfig?: [...#UserPhoneConfigInitParameters] @go(PhoneConfig,[]UserPhoneConfigInitParameters)
...
#UserParameters: {
	...
	// +kubebuilder:validation:Optional
	routingProfileIdRef?: null | v1.#Reference @go(RoutingProfileIDRef,*v1.Reference)

	// Selector for a RoutingProfile in connect to populate routingProfileId.
	// +kubebuilder:validation:Optional
	routingProfileIdSelector?: null | v1.#Selector @go(RoutingProfileIDSelector,*v1.Selector)
