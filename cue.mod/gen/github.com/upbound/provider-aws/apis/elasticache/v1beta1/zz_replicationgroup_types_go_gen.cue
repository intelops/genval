...
#ReplicationGroupInitParameters: {
	...
	clusterMode?: [...#ClusterModeInitParameters] @go(ClusterMode,[]ClusterModeInitParameters)
	...
	logDeliveryConfiguration?: [...#ReplicationGroupLogDeliveryConfigurationInitParameters] @go(LogDeliveryConfiguration,[]ReplicationGroupLogDeliveryConfigurationInitParameters)
...
#ReplicationGroupLogDeliveryConfigurationInitParameters: {
...
#ReplicationGroupParameters: {
	...
	// +kubebuilder:validation:Optional
	authTokenSecretRef?: null | v1.#SecretKeySelector @go(AuthTokenSecretRef,*v1.SecretKeySelector)
...
#ReplicationGroupSpec: {
	...
	// autoscaler.
	initProvider?: #ReplicationGroupInitParameters @go(InitProvider)
}
