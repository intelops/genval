...
#CertificateAuthorityConfigurationInitParameters: {
	...
	subject?: [...#SubjectInitParameters] @go(Subject,[]SubjectInitParameters)
}
...
#CertificateAuthorityInitParameters: {
	...
	certificateAuthorityConfiguration?: [...#CertificateAuthorityConfigurationInitParameters] @go(CertificateAuthorityConfiguration,[]CertificateAuthorityConfigurationInitParameters)
	...
	keyStorageSecurityStandard?: null | string @go(KeyStorageSecurityStandard,*string)

	// Number of days to make a CA restorable after it has been deleted, must be between 7 to 30 days, with default to 30 days.
	permanentDeletionTimeInDays?: null | float64 @go(PermanentDeletionTimeInDays,*float64)

	// Nested argument containing revocation configuration. Defined below.
	revocationConfiguration?: [...#RevocationConfigurationInitParameters] @go(RevocationConfiguration,[]RevocationConfigurationInitParameters)
...
#CrlConfigurationInitParameters: {
...
#OcspConfigurationInitParameters: {
...
#RevocationConfigurationInitParameters: {
	// Nested argument containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority. Defined below.
	crlConfiguration?: [...#CrlConfigurationInitParameters] @go(CrlConfiguration,[]CrlConfigurationInitParameters)

	// Nested argument containing configuration of
	// the custom OCSP responder endpoint. Defined below.
	ocspConfiguration?: [...#OcspConfigurationInitParameters] @go(OcspConfiguration,[]OcspConfigurationInitParameters)
}
