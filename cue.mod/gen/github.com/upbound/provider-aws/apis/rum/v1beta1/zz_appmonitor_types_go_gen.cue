...
#AppMonitorConfigurationInitParameters: {
...
#AppMonitorInitParameters: {
	// configuration data for the app monitor. See app_monitor_configuration below.
	appMonitorConfiguration?: [...#AppMonitorConfigurationInitParameters] @go(AppMonitorConfiguration,[]AppMonitorConfigurationInitParameters)

	// Specifies whether this app monitor allows the web client to define and send custom events. If you omit this parameter, custom events are DISABLED. See custom_events below.
	customEvents?: [...#CustomEventsInitParameters] @go(CustomEvents,[]CustomEventsInitParameters)
...
#AppMonitorSpec: {
	...
	// autoscaler.
	initProvider?: #AppMonitorInitParameters @go(InitProvider)
}
