...
#ConfigurationRecorderInitParameters: {
	// Recording group - see below.
	recordingGroup?: [...#RecordingGroupInitParameters] @go(RecordingGroup,[]RecordingGroupInitParameters)
}
...
#ConfigurationRecorderSpec: {
	...
	// autoscaler.
	initProvider?: #ConfigurationRecorderInitParameters @go(InitProvider)
}
