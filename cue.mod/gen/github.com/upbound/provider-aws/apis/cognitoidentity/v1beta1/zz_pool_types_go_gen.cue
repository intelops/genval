...
#CognitoIdentityProvidersInitParameters: {
...
#PoolInitParameters: {
	...
	cognitoIdentityProviders?: [...#CognitoIdentityProvidersInitParameters] @go(CognitoIdentityProviders,[]CognitoIdentityProvidersInitParameters)
...
#PoolParameters: {
	...
	// +kubebuilder:validation:Optional
	samlProviderArnsRefs?: [...v1.#Reference] @go(SAMLProviderArnsRefs,[]v1.Reference)

	// Selector for a list of SAMLProvider in iam to populate samlProviderArns.
	// +kubebuilder:validation:Optional
	samlProviderArnsSelector?: null | v1.#Selector @go(SAMLProviderArnsSelector,*v1.Selector)
