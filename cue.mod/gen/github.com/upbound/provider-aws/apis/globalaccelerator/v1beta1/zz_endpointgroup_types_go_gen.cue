...
#EndpointGroupInitParameters: {
	...
	portOverride?: [...#PortOverrideInitParameters] @go(PortOverride,[]PortOverrideInitParameters)
...
#EndpointGroupSpec: {
	...
	// autoscaler.
	initProvider?: #EndpointGroupInitParameters @go(InitProvider)
}
