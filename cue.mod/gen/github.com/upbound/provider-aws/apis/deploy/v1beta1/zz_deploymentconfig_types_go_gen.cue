...
#DeploymentConfigInitParameters: {
	// The compute platform can be Server, Lambda, or ECS. Default is Server.
	computePlatform?: null | string @go(ComputePlatform,*string)

	// A minimum_healthy_hosts block. Required for Server compute platform. Minimum Healthy Hosts are documented below.
	minimumHealthyHosts?: [...#MinimumHealthyHostsInitParameters] @go(MinimumHealthyHosts,[]MinimumHealthyHostsInitParameters)

	// A traffic_routing_config block. Traffic Routing Config is documented below.
	trafficRoutingConfig?: [...#TrafficRoutingConfigInitParameters] @go(TrafficRoutingConfig,[]TrafficRoutingConfigInitParameters)
}
...
#MinimumHealthyHostsInitParameters: {
...
#TrafficRoutingConfigInitParameters: {
	// The time based canary configuration information. If type is TimeBasedLinear, use time_based_linear instead.
	timeBasedCanary?: [...#TimeBasedCanaryInitParameters] @go(TimeBasedCanary,[]TimeBasedCanaryInitParameters)

	// The time based linear configuration information. If type is TimeBasedCanary, use time_based_canary instead.
	timeBasedLinear?: [...#TimeBasedLinearInitParameters] @go(TimeBasedLinear,[]TimeBasedLinearInitParameters)
...
#DeploymentConfigSpec: {
	...
	// autoscaler.
	initProvider?: #DeploymentConfigInitParameters @go(InitProvider)
}
