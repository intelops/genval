...
#ApprovalRuleInitParameters: {
	...
	patchFilter?: [...#PatchFilterInitParameters] @go(PatchFilter,[]PatchFilterInitParameters)
}
...
#PatchBaselineInitParameters: {
	// A set of rules used to include patches in the baseline.
	// Up to 10 approval rules can be specified.
	// See approval_rule below.
	approvalRule?: [...#ApprovalRuleInitParameters] @go(ApprovalRule,[]ApprovalRuleInitParameters)
	...
	globalFilter?: [...#GlobalFilterInitParameters] @go(GlobalFilter,[]GlobalFilterInitParameters)
...
#PatchBaselineSpec: {
	...
	// autoscaler.
	initProvider?: #PatchBaselineInitParameters @go(InitProvider)
}
