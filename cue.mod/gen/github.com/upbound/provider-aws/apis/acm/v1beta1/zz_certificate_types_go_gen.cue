...
#CertificateInitParameters: {
	...
	validationOption?: [...#ValidationOptionInitParameters] @go(ValidationOption,[]ValidationOptionInitParameters)
}
...
#CertificateParameters: {
	...
	// +kubebuilder:validation:Optional
	privateKeySecretRef?: null | v1.#SecretKeySelector @go(PrivateKeySecretRef,*v1.SecretKeySelector)
...
#DomainValidationOptionsInitParameters: {
}
...
#ValidationOptionInitParameters: {
	// Fully qualified domain name (FQDN) in the certificate.
	domainName?: null | string @go(DomainName,*string)
