...
#CodeConfigurationInitParameters: {
	// Basic configuration for building and running the App Runner service. Use this parameter to quickly launch an App Runner service without providing an apprunner.yaml file in the source code repository (or ignoring the file if it exists). See Code Configuration Values below for more details.
	codeConfigurationValues?: [...#CodeConfigurationValuesInitParameters] @go(CodeConfigurationValues,[]CodeConfigurationValuesInitParameters)
...
#CodeConfigurationValuesInitParameters: {
...
#CodeRepositoryInitParameters: {
	...
	codeConfiguration?: [...#CodeConfigurationInitParameters] @go(CodeConfiguration,[]CodeConfigurationInitParameters)
	...
	sourceCodeVersion?: [...#SourceCodeVersionInitParameters] @go(SourceCodeVersion,[]SourceCodeVersionInitParameters)
}
...
#EgressConfigurationInitParameters: {
...
#EgressConfigurationParameters: {
	...
	// +kubebuilder:validation:Optional
	vpcConnectorArnRef?: null | v1.#Reference @go(VPCConnectorArnRef,*v1.Reference)

	// Selector for a VPCConnector in apprunner to populate vpcConnectorArn.
	// +kubebuilder:validation:Optional
	vpcConnectorArnSelector?: null | v1.#Selector @go(VPCConnectorArnSelector,*v1.Selector)
}
...
#HealthCheckConfigurationInitParameters: {
...
#ImageConfigurationInitParameters: {
	// Port that your application listens to in the container. Defaults to "8080".
	port?: null | string @go(Port,*string)
...
#ImageRepositoryInitParameters: {
	// Configuration for running the identified image. See Image Configuration below for more details.
	imageConfiguration?: [...#ImageConfigurationInitParameters] @go(ImageConfiguration,[]ImageConfigurationInitParameters)
...
#IngressConfigurationInitParameters: {
...
#NetworkConfigurationInitParameters: {
	...
	egressConfiguration?: [...#EgressConfigurationInitParameters] @go(EgressConfiguration,[]EgressConfigurationInitParameters)

	// Network configuration settings for inbound network traffic. See Ingress Configuration below for more details.
	ingressConfiguration?: [...#IngressConfigurationInitParameters] @go(IngressConfiguration,[]IngressConfigurationInitParameters)
}
...
#ServiceInitParameters: {
	...
	healthCheckConfiguration?: [...#HealthCheckConfigurationInitParameters] @go(HealthCheckConfiguration,[]HealthCheckConfigurationInitParameters)
	...
	observabilityConfiguration?: [...#ServiceObservabilityConfigurationInitParameters] @go(ObservabilityConfiguration,[]ServiceObservabilityConfigurationInitParameters)

	// (Forces new resource) Name of the service.
	serviceName?: null | string @go(ServiceName,*string)

	// The source to deploy to the App Runner service. Can be a code or an image repository. See Source Configuration below for more details.
	sourceConfiguration?: [...#SourceConfigurationInitParameters] @go(SourceConfiguration,[]SourceConfigurationInitParameters)

	// Key-value map of resource tags.
	tags?: {[string]: null | string} @go(Tags,map[string]*string)
}

#ServiceObservabilityConfigurationInitParameters: {
...
#ServiceObservabilityConfigurationParameters: {
	...
	// +kubebuilder:validation:Optional
	observabilityConfigurationArnRef?: null | v1.#Reference @go(ObservabilityConfigurationArnRef,*v1.Reference)

	// Selector for a ObservabilityConfiguration in apprunner to populate observabilityConfigurationArn.
	// +kubebuilder:validation:Optional
	observabilityConfigurationArnSelector?: null | v1.#Selector @go(ObservabilityConfigurationArnSelector,*v1.Selector)
...
#SourceCodeVersionInitParameters: {
...
#SourceConfigurationInitParameters: {
	...
	codeRepository?: [...#CodeRepositoryInitParameters] @go(CodeRepository,[]CodeRepositoryInitParameters)

	// Description of a source image repository. See Image Repository below for more details.
	imageRepository?: [...#ImageRepositoryInitParameters] @go(ImageRepository,[]ImageRepositoryInitParameters)
}
