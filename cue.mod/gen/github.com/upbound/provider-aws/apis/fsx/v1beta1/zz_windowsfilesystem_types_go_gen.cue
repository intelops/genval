...
#AuditLogConfigurationInitParameters: {
...
#SelfManagedActiveDirectoryInitParameters: {
...
#WindowsFileSystemInitParameters: {
	...
	auditLogConfiguration?: [...#AuditLogConfigurationInitParameters] @go(AuditLogConfiguration,[]AuditLogConfigurationInitParameters)
	...
	selfManagedActiveDirectory?: [...#SelfManagedActiveDirectoryInitParameters] @go(SelfManagedActiveDirectory,[]SelfManagedActiveDirectoryInitParameters)
...
#WindowsFileSystemParameters: {
	...
	// +kubebuilder:validation:Optional
	activeDirectoryIdRef?: null | v1.#Reference @go(ActiveDirectoryIDRef,*v1.Reference)

	// Selector for a Directory in ds to populate activeDirectoryId.
	// +kubebuilder:validation:Optional
	activeDirectoryIdSelector?: null | v1.#Selector @go(ActiveDirectoryIDSelector,*v1.Selector)
...
#WindowsFileSystemSpec: {
	...
	// autoscaler.
	initProvider?: #WindowsFileSystemInitParameters @go(InitProvider)
}
