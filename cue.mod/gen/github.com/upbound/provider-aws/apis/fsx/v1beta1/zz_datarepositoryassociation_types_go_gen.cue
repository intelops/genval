...
#AutoExportPolicyInitParameters: {
...
#AutoImportPolicyInitParameters: {
	// A list of file event types to automatically export to your linked S3 bucket or import from the linked S3 bucket. Valid values are NEW, CHANGED, DELETED. Max of 3.
	events?: [...null | string] @go(Events,[]*string)
}
...
#DataRepositoryAssociationInitParameters: {
...
#S3InitParameters: {
	...
	autoExportPolicy?: [...#AutoExportPolicyInitParameters] @go(AutoExportPolicy,[]AutoExportPolicyInitParameters)

	// Specifies the type of updated objects that will be automatically imported from the linked S3 bucket to your file system. See the events configuration block.
	autoImportPolicy?: [...#AutoImportPolicyInitParameters] @go(AutoImportPolicy,[]AutoImportPolicyInitParameters)
}
...
#DataRepositoryAssociationSpec: {
	...
	// autoscaler.
	initProvider?: #DataRepositoryAssociationInitParameters @go(InitProvider)
}
