...
#InstanceMetadataServiceConfigurationInitParameters: {
...
#NotebookInstanceInitParameters: {
	...
	instanceMetadataServiceConfiguration?: [...#InstanceMetadataServiceConfigurationInitParameters] @go(InstanceMetadataServiceConfiguration,[]InstanceMetadataServiceConfigurationInitParameters)
...
#NotebookInstanceParameters: {
	...
	// +kubebuilder:validation:Optional
	defaultCodeRepositoryRef?: null | v1.#Reference @go(DefaultCodeRepositoryRef,*v1.Reference)

	// Selector for a CodeRepository in sagemaker to populate defaultCodeRepository.
	// +kubebuilder:validation:Optional
	defaultCodeRepositorySelector?: null | v1.#Selector @go(DefaultCodeRepositorySelector,*v1.Selector)
...
#NotebookInstanceSpec: {
	...
	// autoscaler.
	initProvider?: #NotebookInstanceInitParameters @go(InitProvider)
}
