...
#KinesisConfigurationInitParameters: {
...
#StreamInitParameters: {
	...
	kinesisConfiguration?: [...#KinesisConfigurationInitParameters] @go(KinesisConfiguration,[]KinesisConfigurationInitParameters)
...
#StreamParameters: {
	...
	// +kubebuilder:validation:Optional
	ledgerNameRef?: null | v1.#Reference @go(LedgerNameRef,*v1.Reference)

	// Selector for a Ledger in qldb to populate ledgerName.
	// +kubebuilder:validation:Optional
	ledgerNameSelector?: null | v1.#Selector @go(LedgerNameSelector,*v1.Selector)
