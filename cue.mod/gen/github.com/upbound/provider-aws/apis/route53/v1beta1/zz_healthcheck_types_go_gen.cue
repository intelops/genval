...
#HealthCheckParameters: {
	...
	// +kubebuilder:validation:Optional
	cloudwatchAlarmNameRef?: null | v1.#Reference @go(CloudwatchAlarmNameRef,*v1.Reference)

	// Selector for a MetricAlarm in cloudwatch to populate cloudwatchAlarmName.
	// +kubebuilder:validation:Optional
	cloudwatchAlarmNameSelector?: null | v1.#Selector @go(CloudwatchAlarmNameSelector,*v1.Selector)
