...
#CatalogTableInitParameters: {
	...
	partitionIndex?: [...#PartitionIndexInitParameters] @go(PartitionIndex,[]PartitionIndexInitParameters)

	// Configuration block of columns by which the table is partitioned. Only primitive types are supported as partition keys. See partition_keys below.
	partitionKeys?: [...#PartitionKeysInitParameters] @go(PartitionKeys,[]PartitionKeysInitParameters)
	...
	storageDescriptor?: [...#StorageDescriptorInitParameters] @go(StorageDescriptor,[]StorageDescriptorInitParameters)

	// Type of this table (EXTERNAL_TABLE, VIRTUAL_VIEW, etc.). While optional, some Athena DDL queries such as ALTER TABLE and SHOW CREATE TABLE will fail if this argument is empty.
	tableType?: null | string @go(TableType,*string)

	// Configuration block of a target table for resource linking. See target_table below.
	targetTable?: [...#TargetTableInitParameters] @go(TargetTable,[]TargetTableInitParameters)
...
#SchemaReferenceInitParameters: {
	// Configuration block that contains schema identity fields. Either this or the schema_version_id has to be provided. See schema_id below.
	schemaId?: [...#SchemaIDInitParameters] @go(SchemaID,[]SchemaIDInitParameters)
...
#StorageDescriptorInitParameters: {
	...
	columns?: [...#ColumnsInitParameters] @go(Columns,[]ColumnsInitParameters)
	...
	schemaReference?: [...#SchemaReferenceInitParameters] @go(SchemaReference,[]SchemaReferenceInitParameters)

	// Configuration block for serialization and deserialization ("SerDe") information. See ser_de_info below.
	serDeInfo?: [...#SerDeInfoInitParameters] @go(SerDeInfo,[]SerDeInfoInitParameters)

	// Configuration block with information about values that appear very frequently in a column (skewed values). See skewed_info below.
	skewedInfo?: [...#SkewedInfoInitParameters] @go(SkewedInfo,[]SkewedInfoInitParameters)

	// Configuration block for the sort order of each bucket in the table. See sort_columns below.
	sortColumns?: [...#SortColumnsInitParameters] @go(SortColumns,[]SortColumnsInitParameters)
...
#CatalogTableSpec: {
	...
	// autoscaler.
	initProvider?: #CatalogTableInitParameters @go(InitProvider)
}
