...
#CatalogDatabaseInitParameters: {
	// Creates a set of default permissions on the table for principals. See create_table_default_permission below.
	createTableDefaultPermission?: [...#CreateTableDefaultPermissionInitParameters] @go(CreateTableDefaultPermission,[]CreateTableDefaultPermissionInitParameters)
	...
	targetDatabase?: [...#TargetDatabaseInitParameters] @go(TargetDatabase,[]TargetDatabaseInitParameters)
}
...
#CreateTableDefaultPermissionInitParameters: {
	// The permissions that are granted to the principal.
	permissions?: [...null | string] @go(Permissions,[]*string)

	// The principal who is granted permissions.. See principal below.
	principal?: [...#PrincipalInitParameters] @go(Principal,[]PrincipalInitParameters)
}
...
#CatalogDatabaseSpec: {
	...
	// autoscaler.
	initProvider?: #CatalogDatabaseInitParameters @go(InitProvider)
}
