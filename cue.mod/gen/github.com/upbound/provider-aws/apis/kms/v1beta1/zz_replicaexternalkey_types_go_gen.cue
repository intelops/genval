...
#ReplicaExternalKeyInitParameters: {
...
#ReplicaExternalKeyParameters: {
	...
	// +kubebuilder:validation:Optional
	keyMaterialBase64SecretRef?: null | v1.#SecretKeySelector @go(KeyMaterialBase64SecretRef,*v1.SecretKeySelector)
...
#ReplicaExternalKeySpec: {
	...
	// autoscaler.
	initProvider?: #ReplicaExternalKeyInitParameters @go(InitProvider)
}
