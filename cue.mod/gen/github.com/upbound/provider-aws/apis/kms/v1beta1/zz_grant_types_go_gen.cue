...
#GrantInitParameters: {
	...
	constraints?: [...#ConstraintsInitParameters] @go(Constraints,[]ConstraintsInitParameters)
...
#GrantParameters: {
	...
	// +kubebuilder:validation:Optional
	granteePrincipalRef?: null | v1.#Reference @go(GranteePrincipalRef,*v1.Reference)

	// Selector for a Role in iam to populate granteePrincipal.
	// +kubebuilder:validation:Optional
	granteePrincipalSelector?: null | v1.#Selector @go(GranteePrincipalSelector,*v1.Selector)
...
#GrantSpec: {
	...
	// autoscaler.
	initProvider?: #GrantInitParameters @go(InitProvider)
}
