...
#AccessPointPolicyInitParameters: {
...
#AccessPointPolicyParameters: {
	...
	// +kubebuilder:validation:Optional
	accessPointArnRef?: null | v1.#Reference @go(AccessPointArnRef,*v1.Reference)

	// Selector for a AccessPoint in s3control to populate accessPointArn.
	// +kubebuilder:validation:Optional
	accessPointArnSelector?: null | v1.#Selector @go(AccessPointArnSelector,*v1.Selector)
...
#AccessPointPolicySpec: {
	...
	// autoscaler.
	initProvider?: #AccessPointPolicyInitParameters @go(InitProvider)
}
