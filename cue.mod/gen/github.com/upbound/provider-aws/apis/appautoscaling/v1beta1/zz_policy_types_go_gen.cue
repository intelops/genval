...
#PolicyInitParameters: {
	...
	stepScalingPolicyConfiguration?: [...#StepScalingPolicyConfigurationInitParameters] @go(StepScalingPolicyConfiguration,[]StepScalingPolicyConfigurationInitParameters)

	// Target tracking policy, requires policy_type = "TargetTrackingScaling". See supported fields below.
	targetTrackingScalingPolicyConfiguration?: [...#TargetTrackingScalingPolicyConfigurationInitParameters] @go(TargetTrackingScalingPolicyConfiguration,[]TargetTrackingScalingPolicyConfigurationInitParameters)
}
...
#TargetTrackingScalingPolicyConfigurationInitParameters: {
