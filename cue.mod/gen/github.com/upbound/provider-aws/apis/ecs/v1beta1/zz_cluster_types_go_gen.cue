...
#ClusterInitParameters: {
	...
	defaultCapacityProviderStrategy?: [...#DefaultCapacityProviderStrategyInitParameters] @go(DefaultCapacityProviderStrategy,[]DefaultCapacityProviderStrategyInitParameters)

	// Configures a default Service Connect namespace. Detailed below.
	serviceConnectDefaults?: [...#ServiceConnectDefaultsInitParameters] @go(ServiceConnectDefaults,[]ServiceConnectDefaultsInitParameters)
...
#ConfigurationInitParameters: {
	...
	executeCommandConfiguration?: [...#ExecuteCommandConfigurationInitParameters] @go(ExecuteCommandConfiguration,[]ExecuteCommandConfigurationInitParameters)
}
...
#DefaultCapacityProviderStrategyInitParameters: {
...
#ExecuteCommandConfigurationInitParameters: {
