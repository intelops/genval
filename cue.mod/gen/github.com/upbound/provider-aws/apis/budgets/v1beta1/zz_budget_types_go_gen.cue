...
#AutoAdjustDataInitParameters: {
	autoAdjustType?: null | string @go(AutoAdjustType,*string)
	historicalOptions?: [...#HistoricalOptionsInitParameters] @go(HistoricalOptions,[]HistoricalOptionsInitParameters)
}
...
#BudgetInitParameters: {
	// The ID of the target account for budget. Will use current user's account_id by default if omitted.
	accountId?: null | string @go(AccountID,*string)

	// Object containing [AutoAdjustData] which determines the budget amount for an auto-adjusting budget.
	autoAdjustData?: [...#AutoAdjustDataInitParameters] @go(AutoAdjustData,[]AutoAdjustDataInitParameters)

	// Whether this budget tracks monetary cost or usage.
	budgetType?: null | string @go(BudgetType,*string)

	// A list of CostFilter name/values pair to apply to budget.
	costFilter?: [...#CostFilterInitParameters] @go(CostFilter,[]CostFilterInitParameters)

	// Map of CostFilters key/value pairs to apply to the budget.
	costFilters?: {[string]: null | string} @go(CostFilters,map[string]*string)

	// Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions.
	costTypes?: [...#CostTypesInitParameters] @go(CostTypes,[]CostTypesInitParameters)
	...
	plannedLimit?: [...#PlannedLimitInitParameters] @go(PlannedLimit,[]PlannedLimitInitParameters)
...
#HistoricalOptionsInitParameters: {
...
#BudgetSpec: {
	...
	// autoscaler.
	initProvider?: #BudgetInitParameters @go(InitProvider)
}
