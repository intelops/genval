...
#ApplicationInitParameters: {
	...
	autoStartConfiguration?: [...#AutoStartConfigurationInitParameters] @go(AutoStartConfiguration,[]AutoStartConfigurationInitParameters)

	// –  The configuration for an application to automatically stop after a certain amount of time being idle.
	autoStopConfiguration?: [...#AutoStopConfigurationInitParameters] @go(AutoStopConfiguration,[]AutoStopConfigurationInitParameters)
	...
	initialCapacity?: [...#InitialCapacityInitParameters] @go(InitialCapacity,[]InitialCapacityInitParameters)

	// –  The maximum capacity to allocate when the application is created. This is cumulative across all workers at any given point in time, not just when an application is created. No new resources will be created once any one of the defined limits is hit.
	maximumCapacity?: [...#MaximumCapacityInitParameters] @go(MaximumCapacity,[]MaximumCapacityInitParameters)
...
#AutoStartConfigurationInitParameters: {
...
#AutoStopConfigurationInitParameters: {
	// Enables the application to automatically start on job submission. Defaults to true.
	enabled?: null | bool @go(Enabled,*bool)
...
#InitialCapacityConfigInitParameters: {
	...
	workerConfiguration?: [...#WorkerConfigurationInitParameters] @go(WorkerConfiguration,[]WorkerConfigurationInitParameters)
...
#InitialCapacityInitParameters: {
	// The initial capacity configuration per worker.
	initialCapacityConfig?: [...#InitialCapacityConfigInitParameters] @go(InitialCapacityConfig,[]InitialCapacityConfigInitParameters)
...
#WorkerConfigurationInitParameters: {
	// The maximum allowed CPU for an application.
	cpu?: null | string @go(CPU,*string)
