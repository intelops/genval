...
#ConfigurationPropertyInitParameters: {
...
#CustomActionTypeInitParameters: {
	// The category of the custom action. Valid values: Source, Build, Deploy, Test, Invoke, Approval
	category?: null | string @go(Category,*string)

	// The configuration properties for the custom action. Max 10 items.
	configurationProperty?: [...#ConfigurationPropertyInitParameters] @go(ConfigurationProperty,[]ConfigurationPropertyInitParameters)

	// The details of the input artifact for the action.
	inputArtifactDetails?: [...#InputArtifactDetailsInitParameters] @go(InputArtifactDetails,[]InputArtifactDetailsInitParameters)

	// The details of the output artifact of the action.
	outputArtifactDetails?: [...#OutputArtifactDetailsInitParameters] @go(OutputArtifactDetails,[]OutputArtifactDetailsInitParameters)
...
#OutputArtifactDetailsInitParameters: {
	// The maximum number of artifacts allowed for the action type. Min: 0, Max: 5
	maximumCount?: null | float64 @go(MaximumCount,*float64)
...
#CustomActionTypeSpec: {
	...
	// autoscaler.
	initProvider?: #CustomActionTypeInitParameters @go(InitProvider)
}
