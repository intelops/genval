...
#DirectoryInitParameters: {
	...
	selfServicePermissions?: [...#SelfServicePermissionsInitParameters] @go(SelfServicePermissions,[]SelfServicePermissionsInitParameters)

	// Key-value map of resource tags.
	tags?: {[string]: null | string} @go(Tags,map[string]*string)

	// –  Specifies which devices and operating systems users can use to access their WorkSpaces. Defined below.
	workspaceAccessProperties?: [...#WorkspaceAccessPropertiesInitParameters] @go(WorkspaceAccessProperties,[]WorkspaceAccessPropertiesInitParameters)

	// –  Default properties that are used for creating WorkSpaces. Defined below.
	workspaceCreationProperties?: [...#WorkspaceCreationPropertiesInitParameters] @go(WorkspaceCreationProperties,[]WorkspaceCreationPropertiesInitParameters)
}
...
#SelfServicePermissionsInitParameters: {
...
#WorkspaceAccessPropertiesInitParameters: {
...
#WorkspaceCreationPropertiesInitParameters: {
...
#WorkspaceCreationPropertiesParameters: {
	...
	// +kubebuilder:validation:Optional
	customSecurityGroupIdRef?: null | v1.#Reference @go(CustomSecurityGroupIDRef,*v1.Reference)
