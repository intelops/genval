...
#ClusterParameters: {
	...
	// +kubebuilder:validation:Optional
	neptuneClusterParameterGroupNameRef?: null | v1.#Reference @go(NeptuneClusterParameterGroupNameRef,*v1.Reference)

	// Selector for a ClusterParameterGroup to populate neptuneClusterParameterGroupName.
	// +kubebuilder:validation:Optional
	neptuneClusterParameterGroupNameSelector?: null | v1.#Selector @go(NeptuneClusterParameterGroupNameSelector,*v1.Selector)
	...
	// +kubebuilder:validation:Optional
	replicationSourceIdentifierRef?: null | v1.#Reference @go(ReplicationSourceIdentifierRef,*v1.Reference)

	// Selector for a Cluster to populate replicationSourceIdentifier.
	// +kubebuilder:validation:Optional
	replicationSourceIdentifierSelector?: null | v1.#Selector @go(ReplicationSourceIdentifierSelector,*v1.Selector)
	...
	// +kubebuilder:validation:Optional
	snapshotIdentifierRef?: null | v1.#Reference @go(SnapshotIdentifierRef,*v1.Reference)

	// Selector for a ClusterSnapshot to populate snapshotIdentifier.
	// +kubebuilder:validation:Optional
	snapshotIdentifierSelector?: null | v1.#Selector @go(SnapshotIdentifierSelector,*v1.Selector)
