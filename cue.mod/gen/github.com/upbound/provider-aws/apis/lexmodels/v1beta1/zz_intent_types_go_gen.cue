...
#ConclusionStatementInitParameters: {
	// A set of messages, each of which provides a message string and its type.
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#ConclusionStatementMessageInitParameters] @go(Message,[]ConclusionStatementMessageInitParameters)
...
#ConfirmationPromptInitParameters: {
	...
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#ConfirmationPromptMessageInitParameters] @go(Message,[]ConfirmationPromptMessageInitParameters)
...
#FollowUpPromptInitParameters: {
	// Prompts for information from the user. Attributes are documented under prompt.
	prompt?: [...#PromptInitParameters] @go(Prompt,[]PromptInitParameters)

	// If the user answers "no" to the question defined in the prompt field,
	// Amazon Lex responds with this statement to acknowledge that the intent was canceled. Attributes are
	// documented below under statement.
	rejectionStatement?: [...#RejectionStatementInitParameters] @go(RejectionStatement,[]RejectionStatementInitParameters)
}
...
#FulfillmentActivityInitParameters: {
	...
	codeHook?: [...#CodeHookInitParameters] @go(CodeHook,[]CodeHookInitParameters)
...
#IntentInitParameters_2: {
	// The statement that you want Amazon Lex to convey to the user
	// after the intent is successfully fulfilled by the Lambda function. This element is relevant only if
	// you provide a Lambda function in the fulfillment_activity. If you return the intent to the client
	// application, you can't specify this element. The follow_up_prompt and conclusion_statement are
	// mutually exclusive. You can specify only one. Attributes are documented under statement.
	conclusionStatement?: [...#ConclusionStatementInitParameters] @go(ConclusionStatement,[]ConclusionStatementInitParameters)

	// Prompts the user to confirm the intent. This question should
	// have a yes or no answer. You you must provide both the rejection_statement and confirmation_prompt,
	// or neither. Attributes are documented under prompt.
	confirmationPrompt?: [...#ConfirmationPromptInitParameters] @go(ConfirmationPrompt,[]ConfirmationPromptInitParameters)
	...
	dialogCodeHook?: [...#DialogCodeHookInitParameters] @go(DialogCodeHook,[]DialogCodeHookInitParameters)

	// Amazon Lex uses this prompt to solicit additional activity after
	// fulfilling an intent. For example, after the OrderPizza intent is fulfilled, you might prompt the
	// user to order a drink. The follow_up_prompt field and the conclusion_statement field are mutually
	// exclusive. You can specify only one. Attributes are documented under follow_up_prompt.
	followUpPrompt?: [...#FollowUpPromptInitParameters] @go(FollowUpPrompt,[]FollowUpPromptInitParameters)

	// Describes how the intent is fulfilled. For example, after a
	// user provides all of the information for a pizza order, fulfillment_activity defines how the bot
	// places an order with a local pizza store. Attributes are documented under fulfillment_activity.
	fulfillmentActivity?: [...#FulfillmentActivityInitParameters] @go(FulfillmentActivity,[]FulfillmentActivityInitParameters)
	...
	rejectionStatement?: [...#IntentRejectionStatementInitParameters] @go(RejectionStatement,[]IntentRejectionStatementInitParameters)
	...
	slot?: [...#SlotInitParameters] @go(Slot,[]SlotInitParameters)
}
...
#IntentRejectionStatementInitParameters: {
	// A set of messages, each of which provides a message string and its type.
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#IntentRejectionStatementMessageInitParameters] @go(Message,[]IntentRejectionStatementMessageInitParameters)
...
#PromptInitParameters: {
	...
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#PromptMessageInitParameters] @go(Message,[]PromptMessageInitParameters)
...
#RejectionStatementInitParameters: {
	...
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#RejectionStatementMessageInitParameters] @go(Message,[]RejectionStatementMessageInitParameters)
...
#RejectionStatementMessageInitParameters: {
	// The text of the message. Must be less than or equal to 1000 characters in length.
	content?: null | string @go(Content,*string)
...
#SlotInitParameters: {
	...
	valueElicitationPrompt?: [...#ValueElicitationPromptInitParameters] @go(ValueElicitationPrompt,[]ValueElicitationPromptInitParameters)
}
...
#ValueElicitationPromptInitParameters: {
	// The number of times to prompt the user for information. Must be a number between 1 and 5 (inclusive).
	maxAttempts?: null | float64 @go(MaxAttempts,*float64)
	...
	// You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
	// Attributes are documented under message. Must contain between 1 and 15 messages.
	message?: [...#ValueElicitationPromptMessageInitParameters] @go(Message,[]ValueElicitationPromptMessageInitParameters)
...
#ValueElicitationPromptMessageInitParameters: {
	// The text of the message. Must be less than or equal to 1000 characters in length.
	content?: null | string @go(Content,*string)
...
#IntentSpec: {
	...
	// autoscaler.
	initProvider?: #IntentInitParameters_2 @go(InitProvider)
}
