...
#MetricAlarmInitParameters: {
	...
	metricQuery?: [...#MetricQueryInitParameters] @go(MetricQuery,[]MetricQueryInitParameters)
...
#MetricAlarmSpec: {
	...
	// autoscaler.
	initProvider?: #MetricAlarmInitParameters @go(InitProvider)
}
