...
#VPCEndpointInitParameters_2: {
	// Accept the VPC endpoint (the VPC endpoint and service need to be in the same AWS account).
	autoAccept?: null | bool @go(AutoAccept,*bool)

	// The DNS options for the endpoint. See dns_options below.
	dnsOptions?: [...#DNSOptionsInitParameters] @go(DNSOptions,[]DNSOptionsInitParameters)
...
#VPCEndpointSpec: {
	...
	// autoscaler.
	initProvider?: #VPCEndpointInitParameters_2 @go(InitProvider)
}
