...
#CapacityReservationSpecificationInitParameters: {
	// Indicates the instance's Capacity Reservation preferences. Can be "open" or "none". (Default: "open").
	capacityReservationPreference?: null | string @go(CapacityReservationPreference,*string)

	// Information about the target Capacity Reservation. See Capacity Reservation Target below for more details.
	capacityReservationTarget?: [...#CapacityReservationTargetInitParameters] @go(CapacityReservationTarget,[]CapacityReservationTargetInitParameters)
}
...
#CapacityReservationTargetInitParameters: {
...
#CreditSpecificationInitParameters: {
...
#InstanceEBSBlockDeviceInitParameters: {
...
#InstanceEphemeralBlockDeviceInitParameters: {
...
#InstanceInitParameters: {
	...
	cpuOptions?: [...#CPUOptionsInitParameters] @go(CPUOptions,[]CPUOptionsInitParameters)

	// If set to 1, hyperthreading is disabled on the launched instance. Defaults to 2 if not set. See Optimizing CPU Options for more information.
	cpuThreadsPerCore?: null | float64 @go(CPUThreadsPerCore,*float64)

	// Describes an instance's Capacity Reservation targeting option. See Capacity Reservation Specification below for more details.
	capacityReservationSpecification?: [...#CapacityReservationSpecificationInitParameters] @go(CapacityReservationSpecification,[]CapacityReservationSpecificationInitParameters)
	...
	creditSpecification?: [...#CreditSpecificationInitParameters] @go(CreditSpecification,[]CreditSpecificationInitParameters)
	...
	ebsBlockDevice?: [...#InstanceEBSBlockDeviceInitParameters] @go(EBSBlockDevice,[]InstanceEBSBlockDeviceInitParameters)
	...
	enclaveOptions?: [...#EnclaveOptionsInitParameters] @go(EnclaveOptions,[]EnclaveOptionsInitParameters)

	// One or more configuration blocks to customize Ephemeral (also known as "Instance Store") volumes on the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a set of objects.
	ephemeralBlockDevice?: [...#InstanceEphemeralBlockDeviceInitParameters] @go(EphemeralBlockDevice,[]InstanceEphemeralBlockDeviceInitParameters)
	...
	maintenanceOptions?: [...#MaintenanceOptionsInitParameters] @go(MaintenanceOptions,[]MaintenanceOptionsInitParameters)

	// Customize the metadata options of the instance. See Metadata Options below for more details.
	metadataOptions?: [...#MetadataOptionsInitParameters] @go(MetadataOptions,[]MetadataOptionsInitParameters)

	// If true, the launched EC2 instance will have detailed monitoring enabled. (Available since v0.6.0)
	monitoring?: null | bool @go(Monitoring,*bool)

	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	networkInterface?: [...#InstanceNetworkInterfaceInitParameters] @go(NetworkInterface,[]InstanceNetworkInterfaceInitParameters)
	...
	privateDnsNameOptions?: [...#PrivateDNSNameOptionsInitParameters] @go(PrivateDNSNameOptions,[]PrivateDNSNameOptionsInitParameters)
...
#InstanceNetworkInterfaceInitParameters: {
...
#MaintenanceOptionsInitParameters: {
...
#PrivateDNSNameOptionsInitParameters: {
