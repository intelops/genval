...
#CloudwatchLogOptionsInitParameters: {
...
#Tunnel1LogOptionsInitParameters: {
	// Options for sending VPN tunnel logs to CloudWatch. See CloudWatch Log Options below for more details.
	cloudwatchLogOptions?: [...#CloudwatchLogOptionsInitParameters] @go(CloudwatchLogOptions,[]CloudwatchLogOptionsInitParameters)
}
...
#Tunnel2LogOptionsCloudwatchLogOptionsInitParameters: {
	// Enable or disable VPN tunnel logging feature. The default is false.
	logEnabled?: null | bool @go(LogEnabled,*bool)
...
#Tunnel2LogOptionsInitParameters: {
	// Options for sending VPN tunnel logs to CloudWatch. See CloudWatch Log Options below for more details.
	cloudwatchLogOptions?: [...#Tunnel2LogOptionsCloudwatchLogOptionsInitParameters] @go(CloudwatchLogOptions,[]Tunnel2LogOptionsCloudwatchLogOptionsInitParameters)
}
...
#VPNConnectionInitParameters_2: {
	...
	tunnel1EnableTunnelLifecycleControl?: null | bool @go(Tunnel1EnableTunnelLifecycleControl,*bool)
	...
	tunnel1LogOptions?: [...#Tunnel1LogOptionsInitParameters] @go(Tunnel1LogOptions,[]Tunnel1LogOptionsInitParameters)
	...
	tunnel2EnableTunnelLifecycleControl?: null | bool @go(Tunnel2EnableTunnelLifecycleControl,*bool)
	...
	// Options for logging VPN tunnel activity. See Log Options below for more details.
	tunnel2LogOptions?: [...#Tunnel2LogOptionsInitParameters] @go(Tunnel2LogOptions,[]Tunnel2LogOptionsInitParameters)
...
#VPNConnectionParameters_2: {
	...
	// +kubebuilder:validation:Optional
	customerGatewayIdRef?: null | v1.#Reference @go(CustomerGatewayIDRef,*v1.Reference)

	// Selector for a CustomerGateway in ec2 to populate customerGatewayId.
	// +kubebuilder:validation:Optional
	customerGatewayIdSelector?: null | v1.#Selector @go(CustomerGatewayIDSelector,*v1.Selector)
	...
	// +kubebuilder:validation:Optional
	tunnel1PresharedKeySecretRef?: null | v1.#SecretKeySelector @go(Tunnel1PresharedKeySecretRef,*v1.SecretKeySelector)
	...
	// +kubebuilder:validation:Optional
	tunnel2PresharedKeySecretRef?: null | v1.#SecretKeySelector @go(Tunnel2PresharedKeySecretRef,*v1.SecretKeySelector)
	...
	// +kubebuilder:validation:Optional
	typeRef?: null | v1.#Reference @go(TypeRef,*v1.Reference)

	// Selector for a CustomerGateway in ec2 to populate type.
	// +kubebuilder:validation:Optional
	typeSelector?: null | v1.#Selector @go(TypeSelector,*v1.Selector)
...
#VPNConnectionSpec: {
	...
	// autoscaler.
	initProvider?: #VPNConnectionInitParameters_2 @go(InitProvider)
}
