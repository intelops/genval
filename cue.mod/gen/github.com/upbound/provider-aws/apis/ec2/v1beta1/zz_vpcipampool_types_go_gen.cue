...
#VPCIpamPoolParameters: {
	...
	// +kubebuilder:validation:Optional
	ipamScopeIdRef?: null | v1.#Reference @go(IpamScopeIDRef,*v1.Reference)

	// Selector for a VPCIpamScope to populate ipamScopeId.
	// +kubebuilder:validation:Optional
	ipamScopeIdSelector?: null | v1.#Selector @go(IpamScopeIDSelector,*v1.Selector)
	...
	// +kubebuilder:validation:Optional
	sourceIpamPoolIdRef?: null | v1.#Reference @go(SourceIpamPoolIDRef,*v1.Reference)

	// Selector for a VPCIpamPool in ec2 to populate sourceIpamPoolId.
	// +kubebuilder:validation:Optional
	sourceIpamPoolIdSelector?: null | v1.#Selector @go(SourceIpamPoolIDSelector,*v1.Selector)
...
#VPCIpamPoolSpec: {
	...
	// autoscaler.
	initProvider?: #VPCIpamPoolInitParameters @go(InitProvider)
}
