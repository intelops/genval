...
#SpotInstanceRequestCPUOptionsInitParameters: {
...
#SpotInstanceRequestCPUOptionsObservation: {
	amdSevSnp?:      null | string  @go(AmdSevSnp,*string)
	coreCount?:      null | float64 @go(CoreCount,*float64)
	threadsPerCore?: null | float64 @go(ThreadsPerCore,*float64)
}

#SpotInstanceRequestCPUOptionsParameters: {
...
#SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTargetInitParameters: {
...
#SpotInstanceRequestCapacityReservationSpecificationInitParameters: {
	capacityReservationPreference?: null | string @go(CapacityReservationPreference,*string)
	capacityReservationTarget?: [...#SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTargetInitParameters] @go(CapacityReservationTarget,[]SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTargetInitParameters)
}
...
#SpotInstanceRequestEBSBlockDeviceInitParameters: {
...
#SpotInstanceRequestEnclaveOptionsInitParameters: {
...
#SpotInstanceRequestEphemeralBlockDeviceInitParameters: {
	deviceName?:  null | string @go(DeviceName,*string)
...
#SpotInstanceRequestInitParameters: {
	...
	cpuOptions?: [...#SpotInstanceRequestCPUOptionsInitParameters] @go(CPUOptions,[]SpotInstanceRequestCPUOptionsInitParameters)
	cpuThreadsPerCore?: null | float64 @go(CPUThreadsPerCore,*float64)
	capacityReservationSpecification?: [...#SpotInstanceRequestCapacityReservationSpecificationInitParameters] @go(CapacityReservationSpecification,[]SpotInstanceRequestCapacityReservationSpecificationInitParameters)
	creditSpecification?: [...#SpotInstanceRequestCreditSpecificationInitParameters] @go(CreditSpecification,[]SpotInstanceRequestCreditSpecificationInitParameters)
	disableApiStop?:        null | bool @go(DisableAPIStop,*bool)
	disableApiTermination?: null | bool @go(DisableAPITermination,*bool)
	ebsBlockDevice?: [...#SpotInstanceRequestEBSBlockDeviceInitParameters] @go(EBSBlockDevice,[]SpotInstanceRequestEBSBlockDeviceInitParameters)
	ebsOptimized?: null | bool @go(EBSOptimized,*bool)
	enclaveOptions?: [...#SpotInstanceRequestEnclaveOptionsInitParameters] @go(EnclaveOptions,[]SpotInstanceRequestEnclaveOptionsInitParameters)
	ephemeralBlockDevice?: [...#SpotInstanceRequestEphemeralBlockDeviceInitParameters] @go(EphemeralBlockDevice,[]SpotInstanceRequestEphemeralBlockDeviceInitParameters)
	...
	launchTemplate?: [...#SpotInstanceRequestLaunchTemplateInitParameters] @go(LaunchTemplate,[]SpotInstanceRequestLaunchTemplateInitParameters)
	maintenanceOptions?: [...#SpotInstanceRequestMaintenanceOptionsInitParameters] @go(MaintenanceOptions,[]SpotInstanceRequestMaintenanceOptionsInitParameters)
	metadataOptions?: [...#SpotInstanceRequestMetadataOptionsInitParameters] @go(MetadataOptions,[]SpotInstanceRequestMetadataOptionsInitParameters)
	monitoring?: null | bool @go(Monitoring,*bool)
	networkInterface?: [...#SpotInstanceRequestNetworkInterfaceInitParameters] @go(NetworkInterface,[]SpotInstanceRequestNetworkInterfaceInitParameters)
	...
	privateDnsNameOptions?: [...#SpotInstanceRequestPrivateDNSNameOptionsInitParameters] @go(PrivateDNSNameOptions,[]SpotInstanceRequestPrivateDNSNameOptionsInitParameters)

	// The private IP address assigned to the instance
	privateIp?: null | string @go(PrivateIP,*string)
	rootBlockDevice?: [...#SpotInstanceRequestRootBlockDeviceInitParameters] @go(RootBlockDevice,[]SpotInstanceRequestRootBlockDeviceInitParameters)
...
#SpotInstanceRequestLaunchTemplateInitParameters: {
	// The Spot Instance Request ID.
...
#SpotInstanceRequestMaintenanceOptionsInitParameters: {
...
#SpotInstanceRequestMetadataOptionsInitParameters: {
...
#SpotInstanceRequestObservation: {
	...
	blockDurationMinutes?: null | float64 @go(BlockDurationMinutes,*float64)
	cpuCoreCount?:         null | float64 @go(CPUCoreCount,*float64)
	cpuOptions?: [...#SpotInstanceRequestCPUOptionsObservation] @go(CPUOptions,[]SpotInstanceRequestCPUOptionsObservation)
	cpuThreadsPerCore?: null | float64 @go(CPUThreadsPerCore,*float64)
...
#SpotInstanceRequestParameters: {
	...
	// +kubebuilder:validation:Optional
	cpuOptions?: [...#SpotInstanceRequestCPUOptionsParameters] @go(CPUOptions,[]SpotInstanceRequestCPUOptionsParameters)
...
#SpotInstanceRequestPrivateDNSNameOptionsInitParameters: {
...
#SpotInstanceRequestRootBlockDeviceInitParameters: {
	deleteOnTermination?: null | bool    @go(DeleteOnTermination,*bool)
	encrypted?:           null | bool    @go(Encrypted,*bool)
	iops?:                null | float64 @go(Iops,*float64)
...
#SpotInstanceRequestSpec: {
	...
	// autoscaler.
	initProvider?: #SpotInstanceRequestInitParameters @go(InitProvider)
}
