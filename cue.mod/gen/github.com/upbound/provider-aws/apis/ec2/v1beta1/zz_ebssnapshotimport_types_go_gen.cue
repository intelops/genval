...
#DiskContainerInitParameters: {
	...
	userBucket?: [...#UserBucketInitParameters] @go(UserBucket,[]UserBucketInitParameters)
}
...
#EBSSnapshotImportInitParameters: {
	// The client-specific data. Detailed below.
	clientData?: [...#ClientDataInitParameters] @go(ClientData,[]ClientDataInitParameters)

	// The description string for the import snapshot task.
	description?: null | string @go(Description,*string)

	// Information about the disk container. Detailed below.
	diskContainer?: [...#DiskContainerInitParameters] @go(DiskContainer,[]DiskContainerInitParameters)
...
#EBSSnapshotImportSpec: {
	...
	// autoscaler.
	initProvider?: #EBSSnapshotImportInitParameters @go(InitProvider)
}
