...
#VPCParameters_2: {
	...
	// +kubebuilder:validation:Optional
	ipv4IpamPoolIdRef?: null | v1.#Reference @go(IPv4IpamPoolIDRef,*v1.Reference)

	// Selector for a VPCIpamPool in ec2 to populate ipv4IpamPoolId.
	// +kubebuilder:validation:Optional
	ipv4IpamPoolIdSelector?: null | v1.#Selector @go(IPv4IpamPoolIDSelector,*v1.Selector)
...
#VPCSpec: {
	...
	// autoscaler.
	initProvider?: #VPCInitParameters_2 @go(InitProvider)
}
