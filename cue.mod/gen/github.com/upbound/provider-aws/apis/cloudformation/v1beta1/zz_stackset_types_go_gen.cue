...
#OperationPreferencesInitParameters: {
...
#StackSetInitParameters: {
	// Configuration block containing the auto-deployment model for your StackSet. This can only be defined when using the SERVICE_MANAGED permission model.
	autoDeployment?: [...#AutoDeploymentInitParameters] @go(AutoDeployment,[]AutoDeploymentInitParameters)
	...
	operationPreferences?: [...#OperationPreferencesInitParameters] @go(OperationPreferences,[]OperationPreferencesInitParameters)
...
#StackSetParameters: {
	...
	// +kubebuilder:validation:Optional
	administrationRoleArnRef?: null | v1.#Reference @go(AdministrationRoleArnRef,*v1.Reference)

	// Selector for a Role in iam to populate administrationRoleArn.
	// +kubebuilder:validation:Optional
	administrationRoleArnSelector?: null | v1.#Selector @go(AdministrationRoleArnSelector,*v1.Selector)
...
#StackSetSpec: {
	...
	// autoscaler.
	initProvider?: #StackSetInitParameters @go(InitProvider)
}
