...
#ContentConfigPermissionsInitParameters: {
...
#PipelineInitParameters: {
	...
	contentConfig?: [...#ContentConfigInitParameters] @go(ContentConfig,[]ContentConfigInitParameters)

	// The permissions for the content_config object. (documented below)
	contentConfigPermissions?: [...#ContentConfigPermissionsInitParameters] @go(ContentConfigPermissions,[]ContentConfigPermissionsInitParameters)

	// The name of the pipeline. Maximum 40 characters
	name?: null | string @go(Name,*string)

	// The Amazon Simple Notification Service (Amazon SNS) topic that you want to notify to report job status. (documented below)
	notifications?: [...#NotificationsInitParameters] @go(Notifications,[]NotificationsInitParameters)

	// The Amazon S3 bucket in which you want Elastic Transcoder to save the transcoded files.
	outputBucket?: null | string @go(OutputBucket,*string)

	// The ThumbnailConfig object specifies information about the Amazon S3 bucket in which you want Elastic Transcoder to save thumbnail files. (documented below)
	thumbnailConfig?: [...#ThumbnailConfigInitParameters] @go(ThumbnailConfig,[]ThumbnailConfigInitParameters)

	// The permissions for the thumbnail_config object. (documented below)
	thumbnailConfigPermissions?: [...#ThumbnailConfigPermissionsInitParameters] @go(ThumbnailConfigPermissions,[]ThumbnailConfigPermissionsInitParameters)
}
...
#PipelineParameters: {
	...
	// +kubebuilder:validation:Optional
	inputBucketRef?: null | v1.#Reference @go(InputBucketRef,*v1.Reference)

	// Selector for a Bucket in s3 to populate inputBucket.
	// +kubebuilder:validation:Optional
	inputBucketSelector?: null | v1.#Selector @go(InputBucketSelector,*v1.Selector)
...
#ThumbnailConfigPermissionsInitParameters: {
	// The permission that you want to give to the AWS user that you specified in content_config_permissions.grantee. Valid values are Read, ReadAcp, WriteAcp or FullControl.
	access?: [...null | string] @go(Access,[]*string)
