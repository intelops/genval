...
#ComplianceStatusInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#CreatedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#DateRangeInitParameters] @go(DateRange,[]DateRangeInitParameters)
...
#FiltersInitParameters: {
	...
	awsAccountId?: [...#AwsAccountIDInitParameters] @go(AwsAccountID,[]AwsAccountIDInitParameters)

	// The name of the findings provider (company) that owns the solution (product) that generates findings. See String_Filter below for more details.
	companyName?: [...#CompanyNameInitParameters] @go(CompanyName,[]CompanyNameInitParameters)

	// Exclusive to findings that are generated as the result of a check run against a specific rule in a supported standard, such as CIS AWS Foundations. Contains security standard-related finding details. See String Filter below for more details.
	complianceStatus?: [...#ComplianceStatusInitParameters] @go(ComplianceStatus,[]ComplianceStatusInitParameters)

	// A finding's confidence. Confidence is defined as the likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. Confidence is scored on a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent confidence. See Number Filter below for more details.
	confidence?: [...#ConfidenceInitParameters] @go(Confidence,[]ConfidenceInitParameters)
	...
	createdAt?: [...#CreatedAtInitParameters] @go(CreatedAt,[]CreatedAtInitParameters)
	...
	criticality?: [...#CriticalityInitParameters] @go(Criticality,[]CriticalityInitParameters)
	...
	findingProviderFieldsConfidence?: [...#FindingProviderFieldsConfidenceInitParameters] @go(FindingProviderFieldsConfidence,[]FindingProviderFieldsConfidenceInitParameters)
	...
	findingProviderFieldsCriticality?: [...#FindingProviderFieldsCriticalityInitParameters] @go(FindingProviderFieldsCriticality,[]FindingProviderFieldsCriticalityInitParameters)
	...
	findingProviderFieldsRelatedFindingsId?: [...#FindingProviderFieldsRelatedFindingsIDInitParameters] @go(FindingProviderFieldsRelatedFindingsID,[]FindingProviderFieldsRelatedFindingsIDInitParameters)
	...
	findingProviderFieldsRelatedFindingsProductArn?: [...#FindingProviderFieldsRelatedFindingsProductArnInitParameters] @go(FindingProviderFieldsRelatedFindingsProductArn,[]FindingProviderFieldsRelatedFindingsProductArnInitParameters)

	// The finding provider value for the severity label. See String Filter below for more details.
	findingProviderFieldsSeverityLabel?: [...#FindingProviderFieldsSeverityLabelInitParameters] @go(FindingProviderFieldsSeverityLabel,[]FindingProviderFieldsSeverityLabelInitParameters)

	// The finding provider's original value for the severity. See String Filter below for more details.
	findingProviderFieldsSeverityOriginal?: [...#FindingProviderFieldsSeverityOriginalInitParameters] @go(FindingProviderFieldsSeverityOriginal,[]FindingProviderFieldsSeverityOriginalInitParameters)

	// One or more finding types that the finding provider assigned to the finding. Uses the format of namespace/category/classifier that classify a finding. Valid namespace values include: Software and Configuration Checks, TTPs, Effects, Unusual Behaviors, and Sensitive Data Identifications. See String Filter below for more details.
	findingProviderFieldsTypes?: [...#FindingProviderFieldsTypesInitParameters] @go(FindingProviderFieldsTypes,[]FindingProviderFieldsTypesInitParameters)
	...
	firstObservedAt?: [...#FirstObservedAtInitParameters] @go(FirstObservedAt,[]FirstObservedAtInitParameters)
	...
	generatorId?: [...#GeneratorIDInitParameters] @go(GeneratorID,[]GeneratorIDInitParameters)

	// The security findings provider-specific identifier for a finding. See String Filter below for more details.
	id?: [...#IDInitParameters] @go(ID,[]IDInitParameters)

	// A keyword for a finding. See Keyword Filter below for more details.
	keyword?: [...#KeywordInitParameters] @go(Keyword,[]KeywordInitParameters)
	...
	lastObservedAt?: [...#LastObservedAtInitParameters] @go(LastObservedAt,[]LastObservedAtInitParameters)

	// The name of the malware that was observed. See String Filter below for more details.
	malwareName?: [...#MalwareNameInitParameters] @go(MalwareName,[]MalwareNameInitParameters)

	// The filesystem path of the malware that was observed. See String Filter below for more details.
	malwarePath?: [...#MalwarePathInitParameters] @go(MalwarePath,[]MalwarePathInitParameters)

	// The state of the malware that was observed. See String Filter below for more details.
	malwareState?: [...#MalwareStateInitParameters] @go(MalwareState,[]MalwareStateInitParameters)

	// The type of the malware that was observed. See String Filter below for more details.
	malwareType?: [...#MalwareTypeInitParameters] @go(MalwareType,[]MalwareTypeInitParameters)

	// The destination domain of network-related information about a finding. See String Filter below for more details.
	networkDestinationDomain?: [...#NetworkDestinationDomainInitParameters] @go(NetworkDestinationDomain,[]NetworkDestinationDomainInitParameters)

	// The destination IPv4 address of network-related information about a finding. See Ip Filter below for more details.
	networkDestinationIpv4?: [...#NetworkDestinationIPv4InitParameters] @go(NetworkDestinationIPv4,[]NetworkDestinationIPv4InitParameters)

	// The destination IPv6 address of network-related information about a finding. See Ip Filter below for more details.
	networkDestinationIpv6?: [...#NetworkDestinationIPv6InitParameters] @go(NetworkDestinationIPv6,[]NetworkDestinationIPv6InitParameters)

	// The destination port of network-related information about a finding. See Number Filter below for more details.
	networkDestinationPort?: [...#NetworkDestinationPortInitParameters] @go(NetworkDestinationPort,[]NetworkDestinationPortInitParameters)

	// Indicates the direction of network traffic associated with a finding. See String Filter below for more details.
	networkDirection?: [...#NetworkDirectionInitParameters] @go(NetworkDirection,[]NetworkDirectionInitParameters)

	// The protocol of network-related information about a finding. See String Filter below for more details.
	networkProtocol?: [...#NetworkProtocolInitParameters] @go(NetworkProtocol,[]NetworkProtocolInitParameters)

	// The source domain of network-related information about a finding. See String Filter below for more details.
	networkSourceDomain?: [...#NetworkSourceDomainInitParameters] @go(NetworkSourceDomain,[]NetworkSourceDomainInitParameters)

	// The source IPv4 address of network-related information about a finding. See Ip Filter below for more details.
	networkSourceIpv4?: [...#NetworkSourceIPv4InitParameters] @go(NetworkSourceIPv4,[]NetworkSourceIPv4InitParameters)

	// The source IPv6 address of network-related information about a finding. See Ip Filter below for more details.
	networkSourceIpv6?: [...#NetworkSourceIPv6InitParameters] @go(NetworkSourceIPv6,[]NetworkSourceIPv6InitParameters)
	...
	networkSourceMac?: [...#NetworkSourceMacInitParameters] @go(NetworkSourceMac,[]NetworkSourceMacInitParameters)

	// The source port of network-related information about a finding. See Number Filter below for more details.
	networkSourcePort?: [...#NetworkSourcePortInitParameters] @go(NetworkSourcePort,[]NetworkSourcePortInitParameters)

	// The text of a note. See String Filter below for more details.
	noteText?: [...#NoteTextInitParameters] @go(NoteText,[]NoteTextInitParameters)

	// The timestamp of when the note was updated. See Date Filter below for more details.
	noteUpdatedAt?: [...#NoteUpdatedAtInitParameters] @go(NoteUpdatedAt,[]NoteUpdatedAtInitParameters)

	// The principal that created a note. See String Filter below for more details.
	noteUpdatedBy?: [...#NoteUpdatedByInitParameters] @go(NoteUpdatedBy,[]NoteUpdatedByInitParameters)

	// The date/time that the process was launched. See Date Filter below for more details.
	processLaunchedAt?: [...#ProcessLaunchedAtInitParameters] @go(ProcessLaunchedAt,[]ProcessLaunchedAtInitParameters)

	// The name of the process. See String Filter below for more details.
	processName?: [...#ProcessNameInitParameters] @go(ProcessName,[]ProcessNameInitParameters)

	// The parent process ID. See Number Filter below for more details.
	processParentPid?: [...#ProcessParentPidInitParameters] @go(ProcessParentPid,[]ProcessParentPidInitParameters)

	// The path to the process executable. See String Filter below for more details.
	processPath?: [...#ProcessPathInitParameters] @go(ProcessPath,[]ProcessPathInitParameters)

	// The process ID. See Number Filter below for more details.
	processPid?: [...#ProcessPidInitParameters] @go(ProcessPid,[]ProcessPidInitParameters)

	// The date/time that the process was terminated. See Date Filter below for more details.
	processTerminatedAt?: [...#ProcessTerminatedAtInitParameters] @go(ProcessTerminatedAt,[]ProcessTerminatedAtInitParameters)
	...
	productArn?: [...#ProductArnInitParameters] @go(ProductArn,[]ProductArnInitParameters)
	...
	productFields?: [...#ProductFieldsInitParameters] @go(ProductFields,[]ProductFieldsInitParameters)

	// The name of the solution (product) that generates findings. See String Filter below for more details.
	productName?: [...#ProductNameInitParameters] @go(ProductName,[]ProductNameInitParameters)

	// The recommendation of what to do about the issue described in a finding. See String Filter below for more details.
	recommendationText?: [...#RecommendationTextInitParameters] @go(RecommendationText,[]RecommendationTextInitParameters)

	// The updated record state for the finding. See String Filter below for more details.
	recordState?: [...#RecordStateInitParameters] @go(RecordState,[]RecordStateInitParameters)

	// The solution-generated identifier for a related finding. See String Filter below for more details.
	relatedFindingsId?: [...#RelatedFindingsIDInitParameters] @go(RelatedFindingsID,[]RelatedFindingsIDInitParameters)

	// The ARN of the solution that generated a related finding. See String Filter below for more details.
	relatedFindingsProductArn?: [...#RelatedFindingsProductArnInitParameters] @go(RelatedFindingsProductArn,[]RelatedFindingsProductArnInitParameters)

	// The IAM profile ARN of the instance. See String Filter below for more details.
	resourceAwsEc2InstanceIamInstanceProfileArn?: [...#ResourceAwsEC2InstanceIAMInstanceProfileArnInitParameters] @go(ResourceAwsEC2InstanceIAMInstanceProfileArn,[]ResourceAwsEC2InstanceIAMInstanceProfileArnInitParameters)

	// The IPv4 addresses associated with the instance. See Ip Filter below for more details.
	resourceAwsEc2InstanceIpv4Addresses?: [...#ResourceAwsEC2InstanceIPv4AddressesInitParameters] @go(ResourceAwsEC2InstanceIPv4Addresses,[]ResourceAwsEC2InstanceIPv4AddressesInitParameters)

	// The IPv6 addresses associated with the instance. See Ip Filter below for more details.
	resourceAwsEc2InstanceIpv6Addresses?: [...#ResourceAwsEC2InstanceIPv6AddressesInitParameters] @go(ResourceAwsEC2InstanceIPv6Addresses,[]ResourceAwsEC2InstanceIPv6AddressesInitParameters)

	// The Amazon Machine Image (AMI) ID of the instance. See String Filter below for more details.
	resourceAwsEc2InstanceImageId?: [...#ResourceAwsEC2InstanceImageIDInitParameters] @go(ResourceAwsEC2InstanceImageID,[]ResourceAwsEC2InstanceImageIDInitParameters)

	// The key name associated with the instance. See String Filter below for more details.
	resourceAwsEc2InstanceKeyName?: [...#ResourceAwsEC2InstanceKeyNameInitParameters] @go(ResourceAwsEC2InstanceKeyName,[]ResourceAwsEC2InstanceKeyNameInitParameters)

	// The date and time the instance was launched. See Date Filter below for more details.
	resourceAwsEc2InstanceLaunchedAt?: [...#ResourceAwsEC2InstanceLaunchedAtInitParameters] @go(ResourceAwsEC2InstanceLaunchedAt,[]ResourceAwsEC2InstanceLaunchedAtInitParameters)

	// The identifier of the subnet that the instance was launched in. See String Filter below for more details.
	resourceAwsEc2InstanceSubnetId?: [...#ResourceAwsEC2InstanceSubnetIDInitParameters] @go(ResourceAwsEC2InstanceSubnetID,[]ResourceAwsEC2InstanceSubnetIDInitParameters)

	// The instance type of the instance. See String Filter below for more details.
	resourceAwsEc2InstanceType?: [...#ResourceAwsEC2InstanceTypeInitParameters] @go(ResourceAwsEC2InstanceType,[]ResourceAwsEC2InstanceTypeInitParameters)

	// The identifier of the VPC that the instance was launched in. See String Filter below for more details.
	resourceAwsEc2InstanceVpcId?: [...#ResourceAwsEC2InstanceVPCIDInitParameters] @go(ResourceAwsEC2InstanceVPCID,[]ResourceAwsEC2InstanceVPCIDInitParameters)

	// The creation date/time of the IAM access key related to a finding. See Date Filter below for more details.
	resourceAwsIamAccessKeyCreatedAt?: [...#ResourceAwsIAMAccessKeyCreatedAtInitParameters] @go(ResourceAwsIAMAccessKeyCreatedAt,[]ResourceAwsIAMAccessKeyCreatedAtInitParameters)

	// The status of the IAM access key related to a finding. See String Filter below for more details.
	resourceAwsIamAccessKeyStatus?: [...#ResourceAwsIAMAccessKeyStatusInitParameters] @go(ResourceAwsIAMAccessKeyStatus,[]ResourceAwsIAMAccessKeyStatusInitParameters)

	// The user associated with the IAM access key related to a finding. See String Filter below for more details.
	resourceAwsIamAccessKeyUserName?: [...#ResourceAwsIAMAccessKeyUserNameInitParameters] @go(ResourceAwsIAMAccessKeyUserName,[]ResourceAwsIAMAccessKeyUserNameInitParameters)

	// The canonical user ID of the owner of the S3 bucket. See String Filter below for more details.
	resourceAwsS3BucketOwnerId?: [...#ResourceAwsS3BucketOwnerIDInitParameters] @go(ResourceAwsS3BucketOwnerID,[]ResourceAwsS3BucketOwnerIDInitParameters)

	// The display name of the owner of the S3 bucket. See String Filter below for more details.
	resourceAwsS3BucketOwnerName?: [...#ResourceAwsS3BucketOwnerNameInitParameters] @go(ResourceAwsS3BucketOwnerName,[]ResourceAwsS3BucketOwnerNameInitParameters)

	// The identifier of the image related to a finding. See String Filter below for more details.
	resourceContainerImageId?: [...#ResourceContainerImageIDInitParameters] @go(ResourceContainerImageID,[]ResourceContainerImageIDInitParameters)

	// The name of the image related to a finding. See String Filter below for more details.
	resourceContainerImageName?: [...#ResourceContainerImageNameInitParameters] @go(ResourceContainerImageName,[]ResourceContainerImageNameInitParameters)

	// The date/time that the container was started. See Date Filter below for more details.
	resourceContainerLaunchedAt?: [...#ResourceContainerLaunchedAtInitParameters] @go(ResourceContainerLaunchedAt,[]ResourceContainerLaunchedAtInitParameters)

	// The name of the container related to a finding. See String Filter below for more details.
	resourceContainerName?: [...#ResourceContainerNameInitParameters] @go(ResourceContainerName,[]ResourceContainerNameInitParameters)
	...
	resourceDetailsOther?: [...#ResourceDetailsOtherInitParameters] @go(ResourceDetailsOther,[]ResourceDetailsOtherInitParameters)

	// The canonical identifier for the given resource type. See String Filter below for more details.
	resourceId?: [...#ResourceIDInitParameters] @go(ResourceID,[]ResourceIDInitParameters)

	// The canonical AWS partition name that the Region is assigned to. See String Filter below for more details.
	resourcePartition?: [...#ResourcePartitionInitParameters] @go(ResourcePartition,[]ResourcePartitionInitParameters)

	// The canonical AWS external Region name where this resource is located. See String Filter below for more details.
	resourceRegion?: [...#ResourceRegionInitParameters] @go(ResourceRegion,[]ResourceRegionInitParameters)
	...
	resourceTags?: [...#ResourceTagsInitParameters] @go(ResourceTags,[]ResourceTagsInitParameters)
	...
	severityLabel?: [...#SeverityLabelInitParameters] @go(SeverityLabel,[]SeverityLabelInitParameters)
	...
	sourceUrl?: [...#SourceURLInitParameters] @go(SourceURL,[]SourceURLInitParameters)

	// The category of a threat intelligence indicator. See String Filter below for more details.
	threatIntelIndicatorCategory?: [...#ThreatIntelIndicatorCategoryInitParameters] @go(ThreatIntelIndicatorCategory,[]ThreatIntelIndicatorCategoryInitParameters)

	// The date/time of the last observation of a threat intelligence indicator. See Date Filter below for more details.
	threatIntelIndicatorLastObservedAt?: [...#ThreatIntelIndicatorLastObservedAtInitParameters] @go(ThreatIntelIndicatorLastObservedAt,[]ThreatIntelIndicatorLastObservedAtInitParameters)

	// The source of the threat intelligence. See String Filter below for more details.
	threatIntelIndicatorSource?: [...#ThreatIntelIndicatorSourceInitParameters] @go(ThreatIntelIndicatorSource,[]ThreatIntelIndicatorSourceInitParameters)

	// The URL for more details from the source of the threat intelligence. See String Filter below for more details.
	threatIntelIndicatorSourceUrl?: [...#ThreatIntelIndicatorSourceURLInitParameters] @go(ThreatIntelIndicatorSourceURL,[]ThreatIntelIndicatorSourceURLInitParameters)

	// The type of a threat intelligence indicator. See String Filter below for more details.
	threatIntelIndicatorType?: [...#ThreatIntelIndicatorTypeInitParameters] @go(ThreatIntelIndicatorType,[]ThreatIntelIndicatorTypeInitParameters)

	// The value of a threat intelligence indicator. See String Filter below for more details.
	threatIntelIndicatorValue?: [...#ThreatIntelIndicatorValueInitParameters] @go(ThreatIntelIndicatorValue,[]ThreatIntelIndicatorValueInitParameters)

	// A finding's title. See String Filter below for more details.
	title?: [...#TitleInitParameters] @go(Title,[]TitleInitParameters)
	...
	updatedAt?: [...#UpdatedAtInitParameters] @go(UpdatedAt,[]UpdatedAtInitParameters)
	...
	userDefinedValues?: [...#UserDefinedValuesInitParameters] @go(UserDefinedValues,[]UserDefinedValuesInitParameters)

	// The veracity of a finding. See String Filter below for more details.
	verificationState?: [...#VerificationStateInitParameters] @go(VerificationState,[]VerificationStateInitParameters)

	// The status of the investigation into a finding. See Workflow Status Filter below for more details.
	workflowStatus?: [...#WorkflowStatusInitParameters] @go(WorkflowStatus,[]WorkflowStatusInitParameters)
}
...
#FindingProviderFieldsConfidenceInitParameters: {
	// The equal-to condition to be applied to a single field when querying for findings, provided as a String.
	eq?: null | string @go(Eq,*string)
...
#FindingProviderFieldsCriticalityInitParameters: {
	// The equal-to condition to be applied to a single field when querying for findings, provided as a String.
	eq?: null | string @go(Eq,*string)
...
#FindingProviderFieldsRelatedFindingsIDInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#FindingProviderFieldsRelatedFindingsProductArnInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#FindingProviderFieldsSeverityOriginalInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#FindingProviderFieldsTypesInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#FirstObservedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#FirstObservedAtDateRangeInitParameters] @go(DateRange,[]FirstObservedAtDateRangeInitParameters)
...
#LastObservedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#LastObservedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#LastObservedAtDateRangeInitParameters] @go(DateRange,[]LastObservedAtDateRangeInitParameters)
...
#NetworkDestinationDomainInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#NetworkDestinationIPv4InitParameters: {
...
#NetworkDestinationIPv6InitParameters: {
	// A finding's CIDR value.
	cidr?: null | string @go(Cidr,*string)
}
...
#NetworkDirectionInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#NetworkSourceDomainInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#NetworkSourceIPv4InitParameters: {
	// A finding's CIDR value.
	cidr?: null | string @go(Cidr,*string)
}
...
#NetworkSourceIPv6InitParameters: {
	// A finding's CIDR value.
	cidr?: null | string @go(Cidr,*string)
}
...
#NetworkSourcePortInitParameters: {
	// The equal-to condition to be applied to a single field when querying for findings, provided as a String.
	eq?: null | string @go(Eq,*string)
...
#NoteUpdatedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#NoteUpdatedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#NoteUpdatedAtDateRangeInitParameters] @go(DateRange,[]NoteUpdatedAtDateRangeInitParameters)
...
#ProcessLaunchedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ProcessLaunchedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ProcessLaunchedAtDateRangeInitParameters] @go(DateRange,[]ProcessLaunchedAtDateRangeInitParameters)
...
#ProcessParentPidInitParameters: {
	// The equal-to condition to be applied to a single field when querying for findings, provided as a String.
	eq?: null | string @go(Eq,*string)
...
#ProcessTerminatedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ProcessTerminatedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ProcessTerminatedAtDateRangeInitParameters] @go(DateRange,[]ProcessTerminatedAtDateRangeInitParameters)
...
#RecommendationTextInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#RelatedFindingsIDInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#RelatedFindingsProductArnInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsEC2InstanceIAMInstanceProfileArnInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsEC2InstanceIPv4AddressesInitParameters: {
	// A finding's CIDR value.
	cidr?: null | string @go(Cidr,*string)
}
...
#ResourceAwsEC2InstanceImageIDInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsEC2InstanceKeyNameInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsEC2InstanceLaunchedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ResourceAwsEC2InstanceLaunchedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ResourceAwsEC2InstanceLaunchedAtDateRangeInitParameters] @go(DateRange,[]ResourceAwsEC2InstanceLaunchedAtDateRangeInitParameters)
...
#ResourceAwsEC2InstanceTypeInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsEC2InstanceVPCIDInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceAwsIAMAccessKeyCreatedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ResourceAwsIAMAccessKeyCreatedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ResourceAwsIAMAccessKeyCreatedAtDateRangeInitParameters] @go(DateRange,[]ResourceAwsIAMAccessKeyCreatedAtDateRangeInitParameters)
...
#ResourceAwsS3BucketOwnerNameInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceContainerImageIDInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceContainerImageNameInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceContainerLaunchedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ResourceContainerLaunchedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ResourceContainerLaunchedAtDateRangeInitParameters] @go(DateRange,[]ResourceContainerLaunchedAtDateRangeInitParameters)
...
#ResourceContainerNameInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourceDetailsOtherInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ResourcePartitionInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ThreatIntelIndicatorCategoryInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ThreatIntelIndicatorLastObservedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#ThreatIntelIndicatorLastObservedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#ThreatIntelIndicatorLastObservedAtDateRangeInitParameters] @go(DateRange,[]ThreatIntelIndicatorLastObservedAtDateRangeInitParameters)
...
#ThreatIntelIndicatorSourceURLInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ThreatIntelIndicatorTypeInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#ThreatIntelIndicatorValueInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#UpdatedAtDateRangeInitParameters: {
	// A date range unit for the date filter. Valid values: DAYS.
	unit?: null | string @go(Unit,*string)
...
#UpdatedAtInitParameters: {
	// A configuration block of the date range for the date filter. See date_range below for more details.
	dateRange?: [...#UpdatedAtDateRangeInitParameters] @go(DateRange,[]UpdatedAtDateRangeInitParameters)
...
#UserDefinedValuesInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#VerificationStateInitParameters: {
	// The condition to apply to a string value when querying for findings. Valid values include: EQUALS and NOT_EQUALS.
	comparison?: null | string @go(Comparison,*string)
...
#InsightSpec: {
	...
	// autoscaler.
	initProvider?: #InsightInitParameters @go(InitProvider)
}
