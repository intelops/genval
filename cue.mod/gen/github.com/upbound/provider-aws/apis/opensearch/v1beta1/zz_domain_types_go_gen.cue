...
#AdvancedSecurityOptionsInitParameters: {
	...
	masterUserOptions?: [...#MasterUserOptionsInitParameters] @go(MasterUserOptions,[]MasterUserOptionsInitParameters)
}
...
#ClusterConfigInitParameters: {
	...
	coldStorageOptions?: [...#ColdStorageOptionsInitParameters] @go(ColdStorageOptions,[]ColdStorageOptionsInitParameters)
	...
	zoneAwarenessConfig?: [...#ZoneAwarenessConfigInitParameters] @go(ZoneAwarenessConfig,[]ZoneAwarenessConfigInitParameters)
...
#DomainEndpointOptionsInitParameters: {
...
#DomainInitParameters: {
	...
	advancedSecurityOptions?: [...#AdvancedSecurityOptionsInitParameters] @go(AdvancedSecurityOptions,[]AdvancedSecurityOptionsInitParameters)

	// Configuration block for the Auto-Tune options of the domain. Detailed below.
	autoTuneOptions?: [...#AutoTuneOptionsInitParameters] @go(AutoTuneOptions,[]AutoTuneOptionsInitParameters)

	// Configuration block for the cluster of the domain. Detailed below.
	clusterConfig?: [...#ClusterConfigInitParameters] @go(ClusterConfig,[]ClusterConfigInitParameters)

	// Configuration block for authenticating dashboard with Cognito. Detailed below.
	cognitoOptions?: [...#CognitoOptionsInitParameters] @go(CognitoOptions,[]CognitoOptionsInitParameters)

	// Configuration block for domain endpoint HTTP(S) related options. Detailed below.
	domainEndpointOptions?: [...#DomainEndpointOptionsInitParameters] @go(DomainEndpointOptions,[]DomainEndpointOptionsInitParameters)
	...
	ebsOptions?: [...#EBSOptionsInitParameters] @go(EBSOptions,[]EBSOptionsInitParameters)

	// Configuration block for encrypt at rest options. Only available for certain instance types. Detailed below.
	encryptAtRest?: [...#EncryptAtRestInitParameters] @go(EncryptAtRest,[]EncryptAtRestInitParameters)
	...
	logPublishingOptions?: [...#LogPublishingOptionsInitParameters] @go(LogPublishingOptions,[]LogPublishingOptionsInitParameters)

	// Configuration block for node-to-node encryption options. Detailed below.
	nodeToNodeEncryption?: [...#NodeToNodeEncryptionInitParameters] @go(NodeToNodeEncryption,[]NodeToNodeEncryptionInitParameters)

	// Configuration block for snapshot related options. Detailed below. DEPRECATED. For domains running OpenSearch 5.3 and later, Amazon OpenSearch takes hourly automated snapshots, making this setting irrelevant. For domains running earlier versions, OpenSearch takes daily automated snapshots.
	snapshotOptions?: [...#SnapshotOptionsInitParameters] @go(SnapshotOptions,[]SnapshotOptionsInitParameters)
	...
	vpcOptions?: [...#VPCOptionsInitParameters] @go(VPCOptions,[]VPCOptionsInitParameters)
}
...
#DomainObservation: {
	...
	dashboardEndpoint?: null | string @go(DashboardEndpoint,*string)
...
#LogPublishingOptionsInitParameters: {
...
#MaintenanceScheduleInitParameters: {
	...
	duration?: [...#DurationInitParameters] @go(Duration,[]DurationInitParameters)
...
#MasterUserOptionsInitParameters: {
...
#MasterUserOptionsParameters: {
	...
	// +kubebuilder:validation:Optional
	masterUserPasswordSecretRef?: null | v1.#SecretKeySelector @go(MasterUserPasswordSecretRef,*v1.SecretKeySelector)
}

#NodeToNodeEncryptionInitParameters: {
...
#ZoneAwarenessConfigInitParameters: {
