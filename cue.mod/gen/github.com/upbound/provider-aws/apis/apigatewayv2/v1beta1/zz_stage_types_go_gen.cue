...
#StageInitParameters: {
	...
	defaultRouteSettings?: [...#DefaultRouteSettingsInitParameters] @go(DefaultRouteSettings,[]DefaultRouteSettingsInitParameters)

	// Description for the stage. Must be less than or equal to 1024 characters in length.
	description?: null | string @go(Description,*string)

	// Route settings for the stage.
	routeSettings?: [...#RouteSettingsInitParameters] @go(RouteSettings,[]RouteSettingsInitParameters)
