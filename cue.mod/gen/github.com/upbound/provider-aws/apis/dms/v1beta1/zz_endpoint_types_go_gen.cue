...
#EndpointInitParameters: {
	...
	elasticsearchSettings?: [...#ElasticsearchSettingsInitParameters] @go(ElasticsearchSettings,[]ElasticsearchSettingsInitParameters)
	...
	kafkaSettings?: [...#KafkaSettingsInitParameters] @go(KafkaSettings,[]KafkaSettingsInitParameters)

	// Configuration block for Kinesis settings. See below.
	kinesisSettings?: [...#KinesisSettingsInitParameters] @go(KinesisSettings,[]KinesisSettingsInitParameters)

	// Configuration block for MongoDB settings. See below.
	mongodbSettings?: [...#MongodbSettingsInitParameters] @go(MongodbSettings,[]MongodbSettingsInitParameters)

	// Port used by the endpoint database.
	port?: null | float64 @go(Port,*float64)
	redisSettings?: [...#RedisSettingsInitParameters] @go(RedisSettings,[]RedisSettingsInitParameters)

	// Configuration block for Redshift settings. See below.
	redshiftSettings?: [...#RedshiftSettingsInitParameters] @go(RedshiftSettings,[]RedshiftSettingsInitParameters)
	...
	s3Settings?: [...#S3SettingsInitParameters] @go(S3Settings,[]S3SettingsInitParameters)
...
#EndpointParameters: {
	...
	// +kubebuilder:validation:Optional
	secretsManagerAccessRoleArnRef?: null | v1.#Reference @go(SecretsManagerAccessRoleArnRef,*v1.Reference)

	// Selector for a Role in iam to populate secretsManagerAccessRoleArn.
	// +kubebuilder:validation:Optional
	secretsManagerAccessRoleArnSelector?: null | v1.#Selector @go(SecretsManagerAccessRoleArnSelector,*v1.Selector)
	...
	// +kubebuilder:validation:Optional
	serviceAccessRoleRef?: null | v1.#Reference @go(ServiceAccessRoleRef,*v1.Reference)

	// Selector for a Role in iam to populate serviceAccessRole.
	// +kubebuilder:validation:Optional
	serviceAccessRoleSelector?: null | v1.#Selector @go(ServiceAccessRoleSelector,*v1.Selector)
...
#KafkaSettingsParameters: {
	...
	// +kubebuilder:validation:Optional
	sslClientKeyPasswordSecretRef?: null | v1.#SecretKeySelector @go(SSLClientKeyPasswordSecretRef,*v1.SecretKeySelector)

	// Secure password you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.
	// +kubebuilder:validation:Optional
	saslPasswordSecretRef?: null | v1.#SecretKeySelector @go(SaslPasswordSecretRef,*v1.SecretKeySelector)
...
#RedisSettingsParameters: {
	...
	// +kubebuilder:validation:Optional
	authPasswordSecretRef?: null | v1.#SecretKeySelector @go(AuthPasswordSecretRef,*v1.SecretKeySelector)
...
#RedshiftSettingsInitParameters: {
