...
#BlockDeviceMappingEBSInitParameters: {
...
#ComponentParameterInitParameters: {
...
#ImageRecipeBlockDeviceMappingInitParameters: {
	// Name of the device. For example, /dev/sda or /dev/xvdb.
	deviceName?: null | string @go(DeviceName,*string)

	// Configuration block with Elastic Block Storage (EBS) block device mapping settings. Detailed below.
	ebs?: [...#BlockDeviceMappingEBSInitParameters] @go(EBS,[]BlockDeviceMappingEBSInitParameters)
...
#ImageRecipeComponentInitParameters: {
	// Configuration block(s) for parameters to configure the component. Detailed below.
	parameter?: [...#ComponentParameterInitParameters] @go(Parameter,[]ComponentParameterInitParameters)
}
...
#ImageRecipeInitParameters: {
	// Configuration block(s) with block device mappings for the image recipe. Detailed below.
	blockDeviceMapping?: [...#ImageRecipeBlockDeviceMappingInitParameters] @go(BlockDeviceMapping,[]ImageRecipeBlockDeviceMappingInitParameters)

	// Ordered configuration block(s) with components for the image recipe. Detailed below.
	component?: [...#ImageRecipeComponentInitParameters] @go(Component,[]ImageRecipeComponentInitParameters)
	...
	systemsManagerAgent?: [...#SystemsManagerAgentInitParameters] @go(SystemsManagerAgent,[]SystemsManagerAgentInitParameters)
...
#SystemsManagerAgentInitParameters: {
...
#ImageRecipeSpec: {
	...
	// autoscaler.
	initProvider?: #ImageRecipeInitParameters @go(InitProvider)
}
