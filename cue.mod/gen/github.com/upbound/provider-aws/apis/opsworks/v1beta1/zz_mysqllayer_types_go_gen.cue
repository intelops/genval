...
#MySQLLayerCloudwatchConfigurationInitParameters: {
	enabled?: null | bool @go(Enabled,*bool)
	logStreams?: [...#MySQLLayerCloudwatchConfigurationLogStreamsInitParameters] @go(LogStreams,[]MySQLLayerCloudwatchConfigurationLogStreamsInitParameters)
}

#MySQLLayerCloudwatchConfigurationLogStreamsInitParameters: {
...
#MySQLLayerEBSVolumeInitParameters: {
...
#MySQLLayerInitParameters: {
	...
	cloudwatchConfiguration?: [...#MySQLLayerCloudwatchConfigurationInitParameters] @go(CloudwatchConfiguration,[]MySQLLayerCloudwatchConfigurationInitParameters)
	...
	ebsVolume?: [...#MySQLLayerEBSVolumeInitParameters] @go(EBSVolume,[]MySQLLayerEBSVolumeInitParameters)
	...
	loadBasedAutoScaling?: [...#MySQLLayerLoadBasedAutoScalingInitParameters] @go(LoadBasedAutoScaling,[]MySQLLayerLoadBasedAutoScalingInitParameters)
...
#MySQLLayerLoadBasedAutoScalingDownscalingInitParameters: {
...
#MySQLLayerLoadBasedAutoScalingInitParameters: {
	downscaling?: [...#MySQLLayerLoadBasedAutoScalingDownscalingInitParameters] @go(Downscaling,[]MySQLLayerLoadBasedAutoScalingDownscalingInitParameters)
	enable?: null | bool @go(Enable,*bool)
	upscaling?: [...#MySQLLayerLoadBasedAutoScalingUpscalingInitParameters] @go(Upscaling,[]MySQLLayerLoadBasedAutoScalingUpscalingInitParameters)
}
...
#MySQLLayerLoadBasedAutoScalingUpscalingInitParameters: {
	alarms?: [...null | string] @go(Alarms,[]*string)
	cpuThreshold?:       null | float64 @go(CPUThreshold,*float64)
	ignoreMetricsTime?:  null | float64 @go(IgnoreMetricsTime,*float64)
	instanceCount?:      null | float64 @go(InstanceCount,*float64)
...
#MySQLLayerSpec: {
	...
	// autoscaler.
	initProvider?: #MySQLLayerInitParameters @go(InitProvider)
}
