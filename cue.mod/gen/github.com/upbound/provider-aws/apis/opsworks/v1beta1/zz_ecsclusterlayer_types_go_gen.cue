...
#EcsClusterLayerCloudwatchConfigurationInitParameters: {
	enabled?: null | bool @go(Enabled,*bool)
	logStreams?: [...#CloudwatchConfigurationLogStreamsInitParameters] @go(LogStreams,[]CloudwatchConfigurationLogStreamsInitParameters)
}
...
#EcsClusterLayerEBSVolumeInitParameters: {
...
#EcsClusterLayerInitParameters: {
	...
	cloudwatchConfiguration?: [...#EcsClusterLayerCloudwatchConfigurationInitParameters] @go(CloudwatchConfiguration,[]EcsClusterLayerCloudwatchConfigurationInitParameters)
	...
	ebsVolume?: [...#EcsClusterLayerEBSVolumeInitParameters] @go(EBSVolume,[]EcsClusterLayerEBSVolumeInitParameters)
	...
	loadBasedAutoScaling?: [...#EcsClusterLayerLoadBasedAutoScalingInitParameters] @go(LoadBasedAutoScaling,[]EcsClusterLayerLoadBasedAutoScalingInitParameters)
...
#EcsClusterLayerLoadBasedAutoScalingInitParameters: {
	downscaling?: [...#LoadBasedAutoScalingDownscalingInitParameters] @go(Downscaling,[]LoadBasedAutoScalingDownscalingInitParameters)
	enable?: null | bool @go(Enable,*bool)
	upscaling?: [...#LoadBasedAutoScalingUpscalingInitParameters] @go(Upscaling,[]LoadBasedAutoScalingUpscalingInitParameters)
}
...
#EcsClusterLayerParameters: {
	...
	// +kubebuilder:validation:Optional
	ecsClusterArnRef?: null | v1.#Reference @go(EcsClusterArnRef,*v1.Reference)

	// Selector for a Cluster in ecs to populate ecsClusterArn.
	// +kubebuilder:validation:Optional
	ecsClusterArnSelector?: null | v1.#Selector @go(EcsClusterArnSelector,*v1.Selector)
...
#LoadBasedAutoScalingDownscalingInitParameters: {
...
#LoadBasedAutoScalingUpscalingInitParameters: {
	alarms?: [...null | string] @go(Alarms,[]*string)
	cpuThreshold?:       null | float64 @go(CPUThreshold,*float64)
	ignoreMetricsTime?:  null | float64 @go(IgnoreMetricsTime,*float64)
	instanceCount?:      null | float64 @go(InstanceCount,*float64)
...
#EcsClusterLayerSpec: {
	...
	// autoscaler.
	initProvider?: #EcsClusterLayerInitParameters @go(InitProvider)
}
