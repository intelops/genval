...
#EcsParametersInitParameters: {
	...
	placementStrategy?: [...#PlacementStrategyInitParameters] @go(PlacementStrategy,[]PlacementStrategyInitParameters)
...
#FlexibleTimeWindowInitParameters: {
...
#KinesisParametersInitParameters: {
...
#PipelineParameterInitParameters: {
...
#PlacementStrategyInitParameters: {
...
#SagemakerPipelineParametersInitParameters: {
	// Set of up to 200 parameter names and values to use when executing the SageMaker Model Building Pipeline. Detailed below.
	pipelineParameter?: [...#PipelineParameterInitParameters] @go(PipelineParameter,[]PipelineParameterInitParameters)
}
...
#ScheduleInitParameters: {
	...
	flexibleTimeWindow?: [...#FlexibleTimeWindowInitParameters] @go(FlexibleTimeWindow,[]FlexibleTimeWindowInitParameters)
...
#TargetInitParameters: {
	...
	ecsParameters?: [...#EcsParametersInitParameters] @go(EcsParameters,[]EcsParametersInitParameters)

	// Templated target type for the EventBridge PutEvents API operation. Detailed below.
	eventbridgeParameters?: [...#EventbridgeParametersInitParameters] @go(EventbridgeParameters,[]EventbridgeParametersInitParameters)
	...
	kinesisParameters?: [...#KinesisParametersInitParameters] @go(KinesisParameters,[]KinesisParametersInitParameters)
	...
	sagemakerPipelineParameters?: [...#SagemakerPipelineParametersInitParameters] @go(SagemakerPipelineParameters,[]SagemakerPipelineParametersInitParameters)

	// The templated target type for the Amazon SQS SendMessage API operation. Detailed below.
	sqsParameters?: [...#SqsParametersInitParameters] @go(SqsParameters,[]SqsParametersInitParameters)
}
