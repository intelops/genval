...
#DNSConfigInitParameters: {
	...
	dnsRecords?: [...#DNSRecordsInitParameters] @go(DNSRecords,[]DNSRecordsInitParameters)
...
#DNSConfigParameters: {
	...
	// +kubebuilder:validation:Optional
	namespaceIdRef?: null | v1.#Reference @go(NamespaceIDRef,*v1.Reference)

	// Selector for a PrivateDNSNamespace in servicediscovery to populate namespaceId.
	// +kubebuilder:validation:Optional
	namespaceIdSelector?: null | v1.#Selector @go(NamespaceIDSelector,*v1.Selector)
...
#HealthCheckConfigInitParameters: {
...
#HealthCheckCustomConfigInitParameters: {
...
#ServiceInitParameters: {
	...
	healthCheckConfig?: [...#HealthCheckConfigInitParameters] @go(HealthCheckConfig,[]HealthCheckConfigInitParameters)

	// A complex type that contains settings for ECS managed health checks.
	healthCheckCustomConfig?: [...#HealthCheckCustomConfigInitParameters] @go(HealthCheckCustomConfig,[]HealthCheckCustomConfigInitParameters)
