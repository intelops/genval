...
#FileSystemInitParameters: {
	...
	lifecyclePolicy?: [...#LifecyclePolicyInitParameters] @go(LifecyclePolicy,[]LifecyclePolicyInitParameters)
...
#FileSystemSpec: {
	...
	// autoscaler.
	initProvider?: #FileSystemInitParameters @go(InitProvider)
}
