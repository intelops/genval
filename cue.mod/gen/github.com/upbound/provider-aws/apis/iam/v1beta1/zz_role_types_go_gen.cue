...
#RoleLastUsedInitParameters: {
}

#RoleLastUsedObservation: {
	lastUsedDate?: null | string @go(LastUsedDate,*string)

	// The name of the AWS Region in which the role was last used.
	region?: null | string @go(Region,*string)
}

#RoleLastUsedParameters: {
}
...
#RoleObservation: {
	...
	roleLastUsed?: [...#RoleLastUsedObservation] @go(RoleLastUsed,[]RoleLastUsedObservation)
