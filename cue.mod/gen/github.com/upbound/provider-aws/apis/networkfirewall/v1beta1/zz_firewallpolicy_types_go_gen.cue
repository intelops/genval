...
#ActionDefinitionInitParameters: {
	// A configuration block describing the stateless inspection criteria that publishes the specified metrics to Amazon CloudWatch for the matching packet. You can pair this custom action with any of the standard stateless rule actions. See Publish Metric Action below for details.
	publishMetricAction?: [...#PublishMetricActionInitParameters] @go(PublishMetricAction,[]PublishMetricActionInitParameters)
}
...
#FirewallPolicyEncryptionConfigurationInitParameters: {
...
#FirewallPolicyFirewallPolicyInitParameters: {
	...
	statefulEngineOptions?: [...#StatefulEngineOptionsInitParameters] @go(StatefulEngineOptions,[]StatefulEngineOptionsInitParameters)

	// Set of configuration blocks containing references to the stateful rule groups that are used in the policy. See Stateful Rule Group Reference below for details.
	statefulRuleGroupReference?: [...#StatefulRuleGroupReferenceInitParameters] @go(StatefulRuleGroupReference,[]StatefulRuleGroupReferenceInitParameters)
	...
	statelessCustomAction?: [...#StatelessCustomActionInitParameters] @go(StatelessCustomAction,[]StatelessCustomActionInitParameters)
	...
	statelessRuleGroupReference?: [...#StatelessRuleGroupReferenceInitParameters] @go(StatelessRuleGroupReference,[]StatelessRuleGroupReferenceInitParameters)
}
...
#FirewallPolicyInitParameters: {
	...
	encryptionConfiguration?: [...#FirewallPolicyEncryptionConfigurationInitParameters] @go(EncryptionConfiguration,[]FirewallPolicyEncryptionConfigurationInitParameters)

	// A configuration block describing the rule groups and policy actions to use in the firewall policy. See Firewall Policy below for details.
	firewallPolicy?: [...#FirewallPolicyFirewallPolicyInitParameters] @go(FirewallPolicy,[]FirewallPolicyFirewallPolicyInitParameters)
...
#StatefulEngineOptionsInitParameters: {
...
#StatefulRuleGroupReferenceInitParameters: {
...
#StatelessCustomActionInitParameters: {
	...
	actionDefinition?: [...#ActionDefinitionInitParameters] @go(ActionDefinition,[]ActionDefinitionInitParameters)
...
#StatelessRuleGroupReferenceInitParameters: {
	// An integer setting that indicates the order in which to run the stateless rule groups in a single policy. AWS Network Firewall applies each stateless rule group to a packet starting with the group that has the lowest priority setting.
	priority?: null | float64 @go(Priority,*float64)
}
