...
#ConditionInitParameters: {
	stringEquals?: [...#StringEqualsInitParameters] @go(StringEquals,[]StringEqualsInitParameters)
	stringLike?: [...#StringLikeInitParameters] @go(StringLike,[]StringLikeInitParameters)
	stringNotEquals?: [...#StringNotEqualsInitParameters] @go(StringNotEquals,[]StringNotEqualsInitParameters)
	stringNotLike?: [...#StringNotLikeInitParameters] @go(StringNotLike,[]StringNotLikeInitParameters)
}
...
#SelectionInitParameters: {
	...
	selectionTag?: [...#SelectionTagInitParameters] @go(SelectionTag,[]SelectionTagInitParameters)
}
...
#SelectionParameters: {
	...
	// +kubebuilder:validation:Optional
	planIdRef?: null | v1.#Reference @go(PlanIDRef,*v1.Reference)

	// Selector for a Plan to populate planId.
	// +kubebuilder:validation:Optional
	planIdSelector?: null | v1.#Selector @go(PlanIDSelector,*v1.Selector)
...
#SelectionSpec: {
	...
	// autoscaler.
	initProvider?: #SelectionInitParameters @go(InitProvider)
}
