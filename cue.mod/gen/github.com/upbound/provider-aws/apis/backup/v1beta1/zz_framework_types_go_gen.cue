...
#FrameworkInitParameters: {
	// One or more control blocks that make up the framework. Each control in the list has a name, input parameters, and scope. Detailed below.
	control?: [...#ControlInitParameters] @go(Control,[]ControlInitParameters)
...
#FrameworkSpec: {
	...
	// autoscaler.
	initProvider?: #FrameworkInitParameters @go(InitProvider)
}
