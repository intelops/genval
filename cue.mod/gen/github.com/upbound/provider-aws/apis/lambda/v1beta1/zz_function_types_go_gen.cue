...
#FunctionInitParameters: {
	...
	snapStart?: [...#SnapStartInitParameters] @go(SnapStart,[]SnapStartInitParameters)
	...
	// Configuration block. Detailed below.
	tracingConfig?: [...#TracingConfigInitParameters] @go(TracingConfig,[]TracingConfigInitParameters)
...
#FunctionParameters: {
	...
	// +kubebuilder:validation:Optional
	replacementSecurityGroupIdRefs?: [...v1.#Reference] @go(ReplacementSecurityGroupIDRefs,[]v1.Reference)

	// Selector for a list of SecurityGroup in ec2 to populate replacementSecurityGroupIds.
	// +kubebuilder:validation:Optional
	replacementSecurityGroupIdSelector?: null | v1.#Selector @go(ReplacementSecurityGroupIDSelector,*v1.Selector)
