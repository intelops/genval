...
#FeatureInitParameters: {
	...
	variations?: [...#VariationsInitParameters] @go(Variations,[]VariationsInitParameters)
}
...
#FeatureSpec: {
	...
	// autoscaler.
	initProvider?: #FeatureInitParameters @go(InitProvider)
}
