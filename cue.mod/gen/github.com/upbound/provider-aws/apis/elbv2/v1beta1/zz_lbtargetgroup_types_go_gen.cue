...
#LBTargetGroupInitParameters: {
	...
	loadBalancingCrossZoneEnabled?: null | string @go(LoadBalancingCrossZoneEnabled,*string)
	...
	stickiness?: [...#LBTargetGroupStickinessInitParameters] @go(Stickiness,[]LBTargetGroupStickinessInitParameters)

	// Key-value map of resource tags.
	tags?: {[string]: null | string} @go(Tags,map[string]*string)

	// Target failover block. Only applicable for Gateway Load Balancer target groups. See target_failover for more information.
	targetFailover?: [...#TargetFailoverInitParameters] @go(TargetFailover,[]TargetFailoverInitParameters)
...
#LBTargetGroupStickinessInitParameters: {
...
#LBTargetGroupSpec: {
	...
	// autoscaler.
	initProvider?: #LBTargetGroupInitParameters @go(InitProvider)
}
