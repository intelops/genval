...
#AuthenticateCognitoInitParameters: {
...
#AuthenticateOidcInitParameters: {
...
#DefaultActionInitParameters: {
	...
	authenticateCognito?: [...#AuthenticateCognitoInitParameters] @go(AuthenticateCognito,[]AuthenticateCognitoInitParameters)

	// Configuration block for an identity provider that is compliant with OpenID Connect (OIDC). Specify only when type is authenticate-oidc. Detailed below.
	authenticateOidc?: [...#AuthenticateOidcInitParameters] @go(AuthenticateOidc,[]AuthenticateOidcInitParameters)

	// Information for creating an action that returns a custom HTTP response. Required if type is fixed-response.
	fixedResponse?: [...#FixedResponseInitParameters] @go(FixedResponse,[]FixedResponseInitParameters)

	// Configuration block for creating an action that distributes requests among one or more target groups. Specify only if type is forward. If you specify both forward block and target_group_arn attribute, you can specify only one target group using forward and it must be the same target group specified in target_group_arn. Detailed below.
	forward?: [...#ForwardInitParameters] @go(Forward,[]ForwardInitParameters)
...
#ForwardInitParameters: {
	// Configuration block for target group stickiness for the rule. Detailed below.
	stickiness?: [...#StickinessInitParameters] @go(Stickiness,[]StickinessInitParameters)
...
#LBListenerParameters: {
	...
	// +kubebuilder:validation:Optional
	loadBalancerArnRef?: null | v1.#Reference @go(LoadBalancerArnRef,*v1.Reference)

	// Selector for a LB to populate loadBalancerArn.
	// +kubebuilder:validation:Optional
	loadBalancerArnSelector?: null | v1.#Selector @go(LoadBalancerArnSelector,*v1.Selector)
...
#LBListenerSpec: {
	...
	// autoscaler.
	initProvider?: #LBListenerInitParameters @go(InitProvider)
}
