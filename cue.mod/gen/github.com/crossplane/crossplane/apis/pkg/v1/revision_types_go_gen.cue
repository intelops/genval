...
#PackageRevisionSpec: {
	...
	// +optional
	webhookTLSSecretName?: null | string @go(WebhookTLSSecretName,*string)
	...
	// +optional
	essTLSSecretName?: null | string @go(ESSTLSSecretName,*string)
}
...
#PackageRevisionStatus: {
	...
	// installed.
	controllerRef?: #ControllerReference @go(ControllerRef)
